...
namespace Com.Payment.Paymentsdk.Integrationmodels {
	...
	public sealed partial class PaymentSdkBillingDetails : global::Com.Payment.Paymentsdk.Integrationmodels.BaseBillingShippingDetails {
		...
		public unsafe PaymentSdkBillingDetails (string p0, string p1, string p2, string p3, string p4, string p5, string p6, string p7) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
