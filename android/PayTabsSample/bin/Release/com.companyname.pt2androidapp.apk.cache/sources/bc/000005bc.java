...
public final class TimeUtils {
    ...
    private static int formatDurationLocked(long j2, int i2) {
        ...
        int printField2 = printField(cArr, i4, 'h', printField, printField != i12, z2 ? 2 : 0);
        int printField3 = printField(cArr, i6, 'm', printField2, printField2 != i12, z2 ? 2 : 0);
        int printField4 = printField(cArr, i5, 's', printField3, printField3 != i12, z2 ? 2 : 0);
        int printField5 = printField(cArr, i10, 'm', printField4, true, (!z2 || printField4 == i12) ? 0 : 3);
        cArr[printField5] = 's';
