...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    */
    ...
    public void collectAdjacentPrefetchPositions(int i2, int i3, RecyclerView.State state, RecyclerView.LayoutManager.LayoutPrefetchRegistry layoutPrefetchRegistry) {
        ...
        for (int i6 = 0; i6 < this.mSpanCount; i6++) {
            if (this.mLayoutState.mItemDirection == -1) {
                ...
                endLine = this.mSpans[i6].getEndLine(this.mLayoutState.mEndLine);
    ...
    public View onFocusSearchFailed(View view, int i2, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        this.mLastLayoutFromEnd = this.mShouldReverseLayout;
        if (z2 || (focusableViewAfter = span.getFocusableViewAfter(firstChildPosition, convertFocusDirectionToLayoutDirection)) == null || focusableViewAfter == findContainingItemView) {
