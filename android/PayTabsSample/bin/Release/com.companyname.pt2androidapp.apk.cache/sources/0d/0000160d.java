...
public class AppOpsManager_OnOpActiveChangedListenerImplementor implements IGCUserPeer, AppOpsManager.OnOpActiveChangedListener {
    ...
    private native void n_onOpActiveChanged(String str, int i2, String str2, boolean z2);
    ...
    public void onOpActiveChanged(String str, int i2, String str2, boolean z2) {
        n_onOpActiveChanged(str, i2, str2, z2);
    }
