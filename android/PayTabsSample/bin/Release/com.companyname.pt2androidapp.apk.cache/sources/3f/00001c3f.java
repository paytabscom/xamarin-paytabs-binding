...
public class TextWatcherImplementor implements IGCUserPeer, TextWatcher, NoCopySpan {
    ...
    private native void n_beforeTextChanged(CharSequence charSequence, int i2, int i3, int i4);

    private native void n_onTextChanged(CharSequence charSequence, int i2, int i3, int i4);
    ...
    public void beforeTextChanged(CharSequence charSequence, int i2, int i3, int i4) {
        n_beforeTextChanged(charSequence, i2, i3, i4);
    }

    @Override // android.text.TextWatcher
    public void onTextChanged(CharSequence charSequence, int i2, int i3, int i4) {
        n_onTextChanged(charSequence, i2, i3, i4);
    }
