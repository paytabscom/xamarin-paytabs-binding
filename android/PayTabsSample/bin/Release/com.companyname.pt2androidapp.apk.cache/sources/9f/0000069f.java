...
public final class SparseArrayKt {
    ...
    public static final <T> T getOrElse(SparseArray<T> sparseArray, int i2, Function0<? extends T> defaultValue) {
        Intrinsics.checkNotNullParameter(sparseArray, "<this>");
    ...
    public static final <T> boolean remove(SparseArray<T> sparseArray, int i2, T t2) {
        ...
        if (indexOfKey < 0 || !Intrinsics.areEqual(t2, sparseArray.valueAt(indexOfKey))) {
            return false;
        }
