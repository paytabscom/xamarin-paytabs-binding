...
public final class DurationKt {
    ...
    private static final long m1407timesmvk6XK0(int i2, long j2) {
        return Duration.m1365timesUwyO8pc(j2, i2);
    }

    /* renamed from: times-kIfJnKk */
    private static final long m1406timeskIfJnKk(double d2, long j2) {
        return Duration.m1364timesUwyO8pc(j2, d2);
    }
    ...
    public static final long durationOfNanos(long j2) {
        return Duration.m1326constructorimpl(j2 << 1);
    }

    public static final long durationOfMillis(long j2) {
        return Duration.m1326constructorimpl((j2 << 1) + 1);
    }

    public static final long durationOf(long j2, int i2) {
        return Duration.m1326constructorimpl((j2 << 1) + i2);
    }
