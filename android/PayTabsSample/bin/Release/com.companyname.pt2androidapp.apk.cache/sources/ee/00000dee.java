...
public final class PaymentSDKSavedCardInfo implements Parcelable {
    ...
    public static /* synthetic */ PaymentSDKSavedCardInfo copy$default(PaymentSDKSavedCardInfo paymentSDKSavedCardInfo, String str, String str2, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            str = paymentSDKSavedCardInfo.f162a;
        }
        if ((i2 & 2) != 0) {
            str2 = paymentSDKSavedCardInfo.f163b;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PaymentSDKSavedCardInfo) {
            ...
            return Intrinsics.areEqual(this.f162a, paymentSDKSavedCardInfo.f162a) && Intrinsics.areEqual(this.f163b, paymentSDKSavedCardInfo.f163b);
        }
        return false;
    }
    ...
    public String toString() {
        return "PaymentSDKSavedCardInfo(maskedCard=" + this.f162a + ", cardType=" + this.f163b + ')';
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel out, int i2) {
        Intrinsics.checkNotNullParameter(out, "out");
        out.writeString(this.f162a);
        out.writeString(this.f163b);
    }
}