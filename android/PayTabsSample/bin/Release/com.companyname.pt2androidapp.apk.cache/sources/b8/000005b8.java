...
public final class SparseLongArrayKt {
    ...
    public static final boolean contains(SparseLongArray contains, int i2) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.indexOfKey(i2) >= 0;
    }

    public static final void set(SparseLongArray set, int i2, long j2) {
    ...
    public static final boolean containsKey(SparseLongArray containsKey, int i2) {
        Intrinsics.checkNotNullParameter(containsKey, "$this$containsKey");
        return containsKey.indexOfKey(i2) >= 0;
    }

    public static final boolean containsValue(SparseLongArray containsValue, long j2) {
        Intrinsics.checkNotNullParameter(containsValue, "$this$containsValue");
        return containsValue.indexOfValue(j2) >= 0;
    }

    public static final long getOrDefault(SparseLongArray getOrDefault, int i2, long j2) {
        Intrinsics.checkNotNullParameter(getOrDefault, "$this$getOrDefault");
        return getOrDefault.get(i2, j2);
    }

    public static final long getOrElse(SparseLongArray getOrElse, int i2, Function0<Long> defaultValue) {
    ...
    public static final boolean remove(SparseLongArray remove, int i2, long j2) {
