...
public final class c {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof c) {
            c cVar = (c) obj;
            return Intrinsics.areEqual(this.f434a, cVar.f434a) && Intrinsics.areEqual(this.f435b, cVar.f435b);
        }
        return false;
    }
    ...
    public String toString() {
        return "QueryTransactionRequestBody(profileId=" + this.f434a + ", transactionReference=" + this.f435b + ')';
    }
}