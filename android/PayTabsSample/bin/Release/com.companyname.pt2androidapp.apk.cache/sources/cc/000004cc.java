...
public final class PathKt {
    ...
    public static final Path plus(Path plus, Path p2) {
    ...
    public static final Path minus(Path minus, Path p2) {
    ...
    public static final Path and(Path and, Path p2) {
    ...
    public static final Path xor(Path xor, Path p2) {
    ...
    public static final Path or(Path or, Path p2) {
