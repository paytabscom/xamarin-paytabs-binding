...
public final class RegionKt {
    public static final boolean contains(Region region, Point p2) {
        Intrinsics.checkNotNullParameter(region, "<this>");
        Intrinsics.checkNotNullParameter(p2, "p");
        return region.contains(p2.x, p2.y);
    }

    public static final Region plus(Region region, Rect r2) {
        Intrinsics.checkNotNullParameter(region, "<this>");
    ...
    public static final Region plus(Region region, Region r2) {
        Intrinsics.checkNotNullParameter(region, "<this>");
        Intrinsics.checkNotNullParameter(r2, "r");
        Region region2 = new Region(region);
    ...
    public static final Region minus(Region region, Rect r2) {
        Intrinsics.checkNotNullParameter(region, "<this>");
        Intrinsics.checkNotNullParameter(r2, "r");
        Region region2 = new Region(region);
    ...
    public static final Region minus(Region region, Region r2) {
        Intrinsics.checkNotNullParameter(region, "<this>");
        Intrinsics.checkNotNullParameter(r2, "r");
        Region region2 = new Region(region);
        region2.op(r2, Region.Op.DIFFERENCE);
    ...
    public static final Region and(Region region, Rect r2) {
        Intrinsics.checkNotNullParameter(region, "<this>");
        Intrinsics.checkNotNullParameter(r2, "r");
        Region region2 = new Region(region);
    ...
    public static final Region and(Region region, Region r2) {
        Intrinsics.checkNotNullParameter(region, "<this>");
        Intrinsics.checkNotNullParameter(r2, "r");
        Region region2 = new Region(region);
        region2.op(r2, Region.Op.INTERSECT);
    ...
    public static final Region xor(Region region, Rect r2) {
        Intrinsics.checkNotNullParameter(region, "<this>");
        Intrinsics.checkNotNullParameter(r2, "r");
        Region region2 = new Region(region);
    ...
    public static final Region xor(Region region, Region r2) {
        Intrinsics.checkNotNullParameter(region, "<this>");
        Intrinsics.checkNotNullParameter(r2, "r");
        Region region2 = new Region(region);
        region2.op(r2, Region.Op.XOR);
    ...
    public static final Region or(Region region, Rect r2) {
        Intrinsics.checkNotNullParameter(region, "<this>");
        Intrinsics.checkNotNullParameter(r2, "r");
        Region region2 = new Region(region);
        region2.union(r2);
    ...
    public static final Region or(Region region, Region r2) {
        Intrinsics.checkNotNullParameter(region, "<this>");
        Intrinsics.checkNotNullParameter(r2, "r");
        Region region2 = new Region(region);
        region2.op(r2, Region.Op.UNION);
