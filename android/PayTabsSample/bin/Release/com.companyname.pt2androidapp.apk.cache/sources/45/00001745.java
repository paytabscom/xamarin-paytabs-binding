...
public final class a extends WebViewClient {
    ...
    public a(String returnUrl, p.a authorizationListener, Context context) {
        ...
        this.f385a = returnUrl;
        this.f386b = authorizationListener;
        this.f387c = context;
    }
    ...
    public void onPageStarted(WebView webView, String str, Bitmap bitmap) {
        ...
        boolean z2 = false;
        this.f386b.a(0);
        if (str != null && StringsKt.contains$default((CharSequence) str, (CharSequence) this.f385a, false, 2, (Object) null)) {
            z2 = true;
        }
        if (z2) {
            this.f386b.a();
    ...
    public void onReceivedSslError(WebView webView, SslErrorHandler handler, SslError sslError) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(this.f387c);
