...
public class XmlReaderResourceParser extends XmlReaderPullParser implements IGCUserPeer, XmlResourceParser, AttributeSet, XmlPullParser {
    ...
    private native boolean n_getAttributeBooleanValue(int i2, boolean z2);

    private native boolean n_getAttributeBooleanValue(String str, String str2, boolean z2);

    private native int n_getAttributeCount();

    private native float n_getAttributeFloatValue(int i2, float f2);

    private native float n_getAttributeFloatValue(String str, String str2, float f2);

    private native int n_getAttributeIntValue(int i2, int i3);

    private native int n_getAttributeIntValue(String str, String str2, int i2);

    private native int n_getAttributeListValue(int i2, String[] strArr, int i3);

    private native int n_getAttributeListValue(String str, String str2, String[] strArr, int i2);

    private native String n_getAttributeName(int i2);

    private native int n_getAttributeNameResource(int i2);

    private native String n_getAttributeNamespace(int i2);

    private native String n_getAttributePrefix(int i2);

    private native int n_getAttributeResourceValue(int i2, int i3);

    private native int n_getAttributeResourceValue(String str, String str2, int i2);

    private native String n_getAttributeType(int i2);

    private native int n_getAttributeUnsignedIntValue(int i2, int i3);

    private native int n_getAttributeUnsignedIntValue(String str, String str2, int i2);

    private native String n_getAttributeValue(int i2);
    ...
    private native int n_getIdAttributeResourceValue(int i2);
    ...
    private native int n_getNamespaceCount(int i2);

    private native String n_getNamespacePrefix(int i2);

    private native String n_getNamespaceUri(int i2);
    ...
    private native boolean n_isAttributeDefault(int i2);
    ...
    private native void n_require(int i2, String str, String str2);

    private native void n_setFeature(String str, boolean z2);
    ...
    public String getAttributeNamespace(int i2) {
        return n_getAttributeNamespace(i2);
    }
    ...
    public int getIdAttributeResourceValue(int i2) {
        return n_getIdAttributeResourceValue(i2);
    }
    ...
    public String getAttributePrefix(int i2) {
        return n_getAttributePrefix(i2);
    }

    @Override // android.runtime.XmlReaderPullParser, org.xmlpull.v1.XmlPullParser
    public String getAttributeType(int i2) {
        return n_getAttributeType(i2);
    }
    ...
    public int getNamespaceCount(int i2) {
        return n_getNamespaceCount(i2);
    }

    @Override // android.runtime.XmlReaderPullParser, org.xmlpull.v1.XmlPullParser
    public String getNamespacePrefix(int i2) {
        return n_getNamespacePrefix(i2);
    }

    @Override // android.runtime.XmlReaderPullParser, org.xmlpull.v1.XmlPullParser
    public String getNamespaceUri(int i2) {
        return n_getNamespaceUri(i2);
    }
    ...
    public boolean isAttributeDefault(int i2) {
        return n_isAttributeDefault(i2);
    }
