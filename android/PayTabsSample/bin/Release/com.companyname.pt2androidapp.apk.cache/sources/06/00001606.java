...
public class LayoutTransition_TransitionListenerImplementor implements IGCUserPeer, LayoutTransition.TransitionListener {
    ...
    private native void n_endTransition(LayoutTransition layoutTransition, ViewGroup viewGroup, View view, int i2);

    private native void n_startTransition(LayoutTransition layoutTransition, ViewGroup viewGroup, View view, int i2);
    ...
    public void endTransition(LayoutTransition layoutTransition, ViewGroup viewGroup, View view, int i2) {
        n_endTransition(layoutTransition, viewGroup, view, i2);
    }

    @Override // android.animation.LayoutTransition.TransitionListener
    public void startTransition(LayoutTransition layoutTransition, ViewGroup viewGroup, View view, int i2) {
        n_startTransition(layoutTransition, viewGroup, view, i2);
    }
