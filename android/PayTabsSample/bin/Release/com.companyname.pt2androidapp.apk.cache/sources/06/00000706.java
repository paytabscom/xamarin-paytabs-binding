...
public class ViewCompat {
    ...
    public static void setHasTransientState(View view, boolean z2) {
        if (Build.VERSION.SDK_INT >= 16) {
            Api16Impl.setHasTransientState(view, z2);
        }
    }
    ...
    public static class Api19Impl {
        ...
        static void setAccessibilityLiveRegion(View view, int i2) {
    ...
    static class Api17Impl {
        ...
        static void setLabelFor(View view, int i2) {
            view.setLabelFor(i2);
        }
        ...
        static void setLayoutDirection(View view, int i2) {
        ...
        static void setPaddingRelative(View view, int i2, int i3, int i4, int i5) {
    ...
    public static class Api16Impl {
        ...
        static void setHasTransientState(View view, boolean z2) {
        ...
        static void postInvalidateOnAnimation(View view, int i2, int i3, int i4, int i5) {
        ...
        static void postOnAnimationDelayed(View view, Runnable runnable, long j2) {
        ...
        static void setImportantForAccessibility(View view, int i2) {
        ...
        static boolean performAccessibilityAction(View view, int i2, Bundle bundle) {
