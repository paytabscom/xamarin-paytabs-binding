...
public class StringsKt__StringsJVMKt extends StringsKt__StringNumberConversionsKt {
    ...
    public static final String replace(String replace, char c2, char c3, boolean z2) {
        ...
        for (int i2 = 0; i2 < str.length(); i2++) {
            ...
            if (CharsKt.equals(charAt, c2, z2)) {
                charAt = c3;
            }
            sb.append(charAt);
        }
    ...
    public static final String replace(String replace, String oldValue, String newValue, boolean z2) {
        ...
        sb.append((CharSequence) str, i2, replace.length());
        String sb2 = sb.toString();
    ...
    public static final String replaceFirst(String replaceFirst, char c2, char c3, boolean z2) {
        Intrinsics.checkNotNullParameter(replaceFirst, "$this$replaceFirst");
        String str = replaceFirst;
        int indexOf$default = StringsKt.indexOf$default(str, c2, 0, z2, 2, (Object) null);
        return indexOf$default < 0 ? replaceFirst : StringsKt.replaceRange((CharSequence) str, indexOf$default, indexOf$default + 1, (CharSequence) String.valueOf(c3)).toString();
    }
    ...
    public static final String decodeToString(byte[] decodeToString, int i2, int i3, boolean z2) {
        Intrinsics.checkNotNullParameter(decodeToString, "$this$decodeToString");
    ...
    public static final byte[] encodeToByteArray(String encodeToByteArray, int i2, int i3, boolean z2) {
        Intrinsics.checkNotNullParameter(encodeToByteArray, "$this$encodeToByteArray");
    ...
    public static final boolean startsWith(String startsWith, String prefix, boolean z2) {
        ...
        return StringsKt.regionMatches(startsWith, 0, prefix, 0, prefix.length(), z2);
    }
    ...
    public static final boolean startsWith(String startsWith, String prefix, int i2, boolean z2) {
        ...
        return StringsKt.regionMatches(startsWith, i2, prefix, 0, prefix.length(), z2);
    }
    ...
    public static final int compareTo(String compareTo, String other, boolean z2) {
    ...
    public static final boolean regionMatches(CharSequence regionMatches, int i2, CharSequence other, int i3, int i4, boolean z2) {
        ...
        if ((regionMatches instanceof String) && (other instanceof String)) {
            return StringsKt.regionMatches((String) regionMatches, i2, (String) other, i3, i4, z2);
        }
        return StringsKt.regionMatchesImpl(regionMatches, i2, other, i3, i4, z2);
    }
    ...
    public static final boolean regionMatches(String regionMatches, int i2, String other, int i3, int i4, boolean z2) {
        ...
        return regionMatches.regionMatches(z2, i2, other, i3, i4);
    }
