...
public abstract class AbstractLongTimeSource implements TimeSource {
    ...
    private static final class LongTimeMark extends TimeMark {
        ...
        public TimeMark mo1297plusLRDsOJo(long j2) {
            return new LongTimeMark(this.startedAt, this.timeSource, Duration.m1341plusLRDsOJo(this.offset, j2));
        }
    }

    @Override // kotlin.time.TimeSource
    public TimeMark markNow() {
        return new LongTimeMark(read(), this, Duration.Companion.m1366getZEROUwyO8pc(), null);
    }
}