...
public abstract class WidgetRun implements Dependency {
    ...
    private void resolveDimension(int i2, int i3) {
        ...
        if (i5 == 0) {
            ...
            WidgetRun widgetRun2 = i2 == 0 ? constraintWidget2.verticalRun : constraintWidget2.horizontalRun;
    ...
    public final int getLimitedDimension(int i2, int i3) {
        ...
        if (i3 == 0) {
            ...
            max = Math.max(this.widget.mMatchConstraintMinWidth, i2);
            if (i4 > 0) {
                max = Math.min(i4, i2);
            }
            if (max == i2) {
            ...
            max = Math.max(this.widget.mMatchConstraintMinHeight, i2);
            if (i5 > 0) {
                max = Math.min(i5, i2);
            }
            if (max == i2) {
