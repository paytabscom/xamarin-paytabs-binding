...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j2, long j3, long j4) {
        ...
        this.first = j2;
        this.last = UProgressionUtilKt.m1232getProgressionLastElement7ftBX0g(j2, j3, j4);
        this.step = j4;
    }

    /* renamed from: getFirst-s-VKNKU  reason: not valid java name */
    public final long m1253getFirstsVKNKU() {
        return this.first;
    }

    /* renamed from: getLast-s-VKNKU  reason: not valid java name */
    public final long m1254getLastsVKNKU() {
        return this.last;
    }
    ...
    public int hashCode() {
        ...
        long j3 = this.last;
        long j4 = this.step;
        return (((((int) ULong.m214constructorimpl(j2 ^ ULong.m214constructorimpl(j2 >>> 32))) * 31) + ((int) ULong.m214constructorimpl(j3 ^ ULong.m214constructorimpl(j3 >>> 32)))) * 31) + ((int) ((j4 >>> 32) ^ j4));
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append(ULong.m259toStringimpl(this.first));
            sb.append("..");
            sb.append(ULong.m259toStringimpl(this.last));
            sb.append(" step ");
            j2 = this.step;
        } else {
            sb = new StringBuilder();
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1255fromClosedRange7ftBX0g(long j2, long j3, long j4) {
