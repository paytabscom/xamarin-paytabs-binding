...
class DefaultSpecialEffectsController extends SpecialEffectsController {
    ...
    void executeOperations(List<SpecialEffectsController.Operation> list, boolean z2) {
    ...
    private void startAnimations(List<AnimationInfo> list, List<SpecialEffectsController.Operation> list2, boolean z2, Map<SpecialEffectsController.Operation, Boolean> map) {
    ...
    private Map<SpecialEffectsController.Operation, Boolean> startTransitions(List<TransitionInfo> list, List<SpecialEffectsController.Operation> list2, final boolean z2, final SpecialEffectsController.Operation operation, final SpecialEffectsController.Operation operation2) {
        View view;
        Object obj;
        ...
        while (it.hasNext()) {
            ...
            if (next.isVisibilityUnchanged()) {
                hashMap5.put(next.getOperation(), Boolean.valueOf(z5));
                ...
                boolean z6 = obj3 != null && (operation10 == operation9 || operation10 == operation8);
                if (cloneTransition == null) {
                    if (!z6) {
                        hashMap5.put(operation10, Boolean.valueOf(z5));
                        next.completeSpecialEffect();
                    }
                    view = view15;
        ...
        for (final TransitionInfo transitionInfo4 : list) {
            if (!transitionInfo4.isVisibilityUnchanged()) {
                ...
                boolean z7 = obj3 != null && (operation11 == operation9 || operation11 == operation8);
