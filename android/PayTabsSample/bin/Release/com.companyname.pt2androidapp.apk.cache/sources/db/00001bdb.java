...
public class MediaPlayer_OnDrmPreparedListenerImplementor implements IGCUserPeer, MediaPlayer.OnDrmPreparedListener {
    ...
    private native void n_onDrmPrepared(MediaPlayer mediaPlayer, int i2);
    ...
    public void onDrmPrepared(MediaPlayer mediaPlayer, int i2) {
        n_onDrmPrepared(mediaPlayer, i2);
    }
