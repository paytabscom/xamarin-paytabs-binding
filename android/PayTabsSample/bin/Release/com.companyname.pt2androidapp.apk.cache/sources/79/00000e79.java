...
public final class c {
    ...
    private final String c() {
        String packageName = this.f182a.getPackageName();
    ...
    private final DisplayMetrics g() {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            Display display = this.f182a.getDisplay();
            if (display != null) {
                display.getRealMetrics(displayMetrics);
            }
        } else {
            this.f182a.getWindowManager().getDefaultDisplay().getMetrics(displayMetrics);
        }
    ...
    private final PackageInfo j() {
        ...
        if (packageManager != null) {
            return packageManager.getPackageInfo(this.f182a.getPackageName(), 0);
        }
        return null;
    }
    ...
    public final String d() {
        return a.b(this.f182a) ? "wifi" : "lte";
    }
