...
public class TextureView_SurfaceTextureListenerImplementor implements IGCUserPeer, TextureView.SurfaceTextureListener {
    ...
    private native void n_onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i2, int i3);

    private native boolean n_onSurfaceTextureDestroyed(SurfaceTexture surfaceTexture);

    private native void n_onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i2, int i3);
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i2, int i3) {
        n_onSurfaceTextureAvailable(surfaceTexture, i2, i3);
    }
    ...
    public void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i2, int i3) {
        n_onSurfaceTextureSizeChanged(surfaceTexture, i2, i3);
    }
