...
public final class ByteStringKt {
    ...
    public static final ByteString commonSubstring(ByteString commonSubstring, int i2, int i3) {
        ...
        if (i3 <= commonSubstring.getData$okio().length) {
            if (i3 - i2 >= 0) {
                return (i2 == 0 && i3 == commonSubstring.getData$okio().length) ? commonSubstring : new ByteString(ArraysKt.copyOfRange(commonSubstring.getData$okio(), i2, i3));
            }
    ...
    public static final byte commonGetByte(ByteString commonGetByte, int i2) {
    ...
    public static final boolean commonRangeEquals(ByteString commonRangeEquals, int i2, ByteString other, int i3, int i4) {
        Intrinsics.checkNotNullParameter(commonRangeEquals, "$this$commonRangeEquals");
        Intrinsics.checkNotNullParameter(other, "other");
        return other.rangeEquals(i3, commonRangeEquals.getData$okio(), i2, i4);
    }

    public static final boolean commonRangeEquals(ByteString commonRangeEquals, int i2, byte[] other, int i3, int i4) {
        Intrinsics.checkNotNullParameter(commonRangeEquals, "$this$commonRangeEquals");
        Intrinsics.checkNotNullParameter(other, "other");
        return i2 >= 0 && i2 <= commonRangeEquals.getData$okio().length - i4 && i3 >= 0 && i3 <= other.length - i4 && Util.arrayRangeEquals(commonRangeEquals.getData$okio(), i2, other, i3, i4);
    }
    ...
    public static final int commonIndexOf(ByteString commonIndexOf, byte[] other, int i2) {
    ...
    public static final int commonLastIndexOf(ByteString commonLastIndexOf, ByteString other, int i2) {
    ...
    public static final int commonLastIndexOf(ByteString commonLastIndexOf, byte[] other, int i2) {
        Intrinsics.checkNotNullParameter(commonLastIndexOf, "$this$commonLastIndexOf");
        Intrinsics.checkNotNullParameter(other, "other");
    ...
    public static final int commonCompareTo(ByteString commonCompareTo, ByteString other) {
        ...
        for (int i2 = 0; i2 < min; i2++) {
            int i3 = commonCompareTo.getByte(i2) & UByte.MAX_VALUE;
            int i4 = other.getByte(i2) & UByte.MAX_VALUE;
            if (i3 != i4) {
                return i3 < i4 ? -1 : 1;
            }
        }
    ...
    public static final ByteString commonToByteString(byte[] commonToByteString, int i2, int i3) {
        ...
        return new ByteString(ArraysKt.copyOfRange(commonToByteString, i2, i3 + i2));
    }
    ...
    public static final void commonWrite(ByteString commonWrite, Buffer buffer, int i2, int i3) {
