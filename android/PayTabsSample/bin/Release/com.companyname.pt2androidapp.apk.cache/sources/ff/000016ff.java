...
public class DrawerLayout_DrawerListenerImplementor implements IGCUserPeer, DrawerLayout.DrawerListener {
    ...
    private native void n_onDrawerSlide(View view, float f2);

    private native void n_onDrawerStateChanged(int i2);
    ...
    public void onDrawerSlide(View view, float f2) {
        n_onDrawerSlide(view, f2);
    }

    @Override // androidx.drawerlayout.widget.DrawerLayout.DrawerListener
    public void onDrawerStateChanged(int i2) {
        n_onDrawerStateChanged(i2);
    }
