...
public class ViewPager extends ViewGroup {
    ...
    */
    ...
    private void calculatePageOffsets(ItemInfo itemInfo, int i2, ItemInfo itemInfo2) {
        ...
        int i7 = count - 1;
        this.mLastOffset = itemInfo.position == i7 ? (itemInfo.offset + itemInfo.widthFactor) - 1.0f : Float.MAX_VALUE;
        int i8 = i2 - 1;
        while (i8 >= 0) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (i2 != -1) {
                ...
                if (i3 != 0 && !isGutterDrag(this.mLastMotionX, f2) && canScroll(this, false, (int) f2, (int) x3, (int) y3)) {
    ...
    public class MyAccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View view, int i2, Bundle bundle) {
            ...
            if (i2 == 4096) {
                ...
                return false;
            } else if (i2 == 8192 && ViewPager.this.canScrollHorizontally(-1)) {
