...
public final class RegionKt {
    public static final boolean contains(Region contains, Point p2) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        Intrinsics.checkNotNullParameter(p2, "p");
        return contains.contains(p2.x, p2.y);
    }

    public static final Region plus(Region plus, Rect r2) {
    ...
    public static final Region plus(Region plus, Region r2) {
        Intrinsics.checkNotNullParameter(plus, "$this$plus");
        Intrinsics.checkNotNullParameter(r2, "r");
        Region region = new Region(plus);
    ...
    public static final Region minus(Region minus, Rect r2) {
    ...
    public static final Region minus(Region minus, Region r2) {
        Intrinsics.checkNotNullParameter(minus, "$this$minus");
        Intrinsics.checkNotNullParameter(r2, "r");
        Region region = new Region(minus);
        region.op(r2, Region.Op.DIFFERENCE);
    ...
    public static final Region and(Region and, Rect r2) {
    ...
    public static final Region and(Region and, Region r2) {
        Intrinsics.checkNotNullParameter(and, "$this$and");
        Intrinsics.checkNotNullParameter(r2, "r");
        Region region = new Region(and);
        region.op(r2, Region.Op.INTERSECT);
    ...
    public static final Region xor(Region xor, Rect r2) {
    ...
    public static final Region xor(Region xor, Region r2) {
        Intrinsics.checkNotNullParameter(xor, "$this$xor");
        Intrinsics.checkNotNullParameter(r2, "r");
        Region region = new Region(xor);
        region.op(r2, Region.Op.XOR);
    ...
    public static final Region or(Region or, Rect r2) {
    ...
    public static final Region or(Region or, Region r2) {
        Intrinsics.checkNotNullParameter(or, "$this$or");
        Intrinsics.checkNotNullParameter(r2, "r");
        Region region = new Region(or);
        region.op(r2, Region.Op.UNION);
