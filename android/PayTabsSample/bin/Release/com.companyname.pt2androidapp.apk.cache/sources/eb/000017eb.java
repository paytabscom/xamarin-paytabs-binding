...
final class AdjustedTimeMark extends TimeMark {
    ...
    public final long m1319getAdjustmentUwyO8pc() {
    ...
    public long mo1317elapsedNowUwyO8pc() {
        return Duration.m1361minusLRDsOJo(this.mark.mo1317elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1318plusLRDsOJo(long j2) {
        return new AdjustedTimeMark(this.mark, Duration.m1362plusLRDsOJo(this.adjustment, j2));
    }
}