...
public class JavaProxyThrowable extends Error implements IGCUserPeer {
    ...
    public JavaProxyThrowable(String str, Throwable th, boolean z2, boolean z3) {
        super(str, th, z2, z3);
        if (getClass() == JavaProxyThrowable.class) {
            TypeManager.Activate("Android.Runtime.JavaProxyThrowable, Mono.Android", "System.String, mscorlib:Java.Lang.Throwable, Mono.Android:System.Boolean, mscorlib:System.Boolean, mscorlib", this, new Object[]{str, th, Boolean.valueOf(z2), Boolean.valueOf(z3)});
        }
    }
