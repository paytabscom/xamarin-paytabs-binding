...
public final class UnsignedKt {
    ...
    public static final int m368uintDivideJ1ME1BU(int i2, int i3) {
        return UInt.m115constructorimpl((int) ((i2 & 4294967295L) / (i3 & 4294967295L)));
    }

    /* renamed from: uintRemainder-J1ME1BU  reason: not valid java name */
    public static final int m369uintRemainderJ1ME1BU(int i2, int i3) {
        return UInt.m115constructorimpl((int) ((i2 & 4294967295L) % (i3 & 4294967295L)));
    }

    /* renamed from: ulongDivide-eb3DHEI  reason: not valid java name */
    public static final long m370ulongDivideeb3DHEI(long j2, long j3) {
        if (j3 < 0) {
            return ulongCompare(j2, j3) < 0 ? ULong.m193constructorimpl(0L) : ULong.m193constructorimpl(1L);
        } else if (j2 >= 0) {
            return ULong.m193constructorimpl(j2 / j3);
        } else {
            long j4 = ((j2 >>> 1) / j3) << 1;
            return ULong.m193constructorimpl(j4 + (ulongCompare(ULong.m193constructorimpl(j2 - (j4 * j3)), ULong.m193constructorimpl(j3)) < 0 ? 0 : 1));
        }
    }

    /* renamed from: ulongRemainder-eb3DHEI  reason: not valid java name */
    public static final long m371ulongRemaindereb3DHEI(long j2, long j3) {
        if (j3 < 0) {
            return ulongCompare(j2, j3) < 0 ? j2 : ULong.m193constructorimpl(j2 - j3);
        } else if (j2 >= 0) {
            return ULong.m193constructorimpl(j2 % j3);
        } else {
            long j4 = j2 - ((((j2 >>> 1) / j3) << 1) * j3);
            if (ulongCompare(ULong.m193constructorimpl(j4), ULong.m193constructorimpl(j3)) < 0) {
                j3 = 0;
            }
            return ULong.m193constructorimpl(j4 - j3);
        }
    }
    ...
    public static final int doubleToUInt(double d2) {
        if (!Double.isNaN(d2) && d2 > uintToDouble(0)) {
            ...
            if (d2 <= d3) {
                return UInt.m115constructorimpl((int) d2);
            }
            return UInt.m115constructorimpl(UInt.m115constructorimpl((int) (d2 - d3)) + UInt.m115constructorimpl(Integer.MAX_VALUE));
        }
        return 0;
    }
    ...
    public static final long doubleToULong(double d2) {
        if (!Double.isNaN(d2) && d2 > ulongToDouble(0L)) {
            ...
            if (d2 < ((double) LongCompanionObject.MAX_VALUE)) {
                return ULong.m193constructorimpl((long) d2);
            }
            return ULong.m193constructorimpl(ULong.m193constructorimpl((long) (d2 - 9.223372036854776E18d)) - Long.MIN_VALUE);
        }
        return 0L;
    }
