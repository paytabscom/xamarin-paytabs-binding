...
public final class UIntArrayKt {
    ...
    private static final int[] m185uintArrayOfajY9A(int... iArr) {
        return iArr;
    }
    ...
    private static final int[] UIntArray(int i2, Function1<? super Integer, UInt> function1) {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            iArr[i3] = function1.invoke(Integer.valueOf(i3)).m166unboximpl();
        }
        return UIntArray.m169constructorimpl(iArr);
    }
}