...
public final class LongSparseArrayKt {
    ...
    public static final <T> void set(LongSparseArray<T> set, long j2, T t2) {
    ...
    public static final <T> boolean containsValue(LongSparseArray<T> containsValue, T t2) {
        Intrinsics.checkNotNullParameter(containsValue, "$this$containsValue");
        return containsValue.indexOfValue(t2) >= 0;
    }

    public static final <T> T getOrDefault(LongSparseArray<T> getOrDefault, long j2, T t2) {
        Intrinsics.checkNotNullParameter(getOrDefault, "$this$getOrDefault");
        T t3 = getOrDefault.get(j2);
        return t3 != null ? t3 : t2;
    }

    public static final <T> T getOrElse(LongSparseArray<T> getOrElse, long j2, Function0<? extends T> defaultValue) {
    ...
    public static final <T> boolean remove(LongSparseArray<T> remove, long j2, T t2) {
