...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m42constructorimpl = Result.m42constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m42constructorimpl = Result.m42constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = Result.m48isFailureimpl(m42constructorimpl) ? null : m42constructorimpl;
    ...
    public static final void m1457installSignalHandler$lambda1(Signal signal) {
