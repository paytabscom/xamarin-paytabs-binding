...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    */
    ...
    void completeExecute(BackStackRecord backStackRecord, boolean z2, boolean z3, boolean z4) {
        if (z2) {
    ...
    public void restoreSaveState(Parcelable parcelable) {
        ...
        if (fragmentManagerState.mBackStack != null) {
            ...
            for (int i2 = 0; i2 < fragmentManagerState.mBackStack.length; i2++) {
                BackStackRecord instantiate = fragmentManagerState.mBackStack[i2].instantiate(this);
                if (isLoggingEnabled(2)) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void launchStartIntentSenderForResult(Fragment fragment, IntentSender intentSender, int i2, Intent intent, int i3, int i4, int i5, Bundle bundle) throws IntentSender.SendIntentException {
        Intent intent2;
    ...
    public static class StartEnterTransitionListener implements Fragment.OnStartEnterTransitionListener {
        ...
        void completeTransaction() {
            ...
            this.mRecord.mManager.completeExecute(this.mRecord, this.mIsBack, !z2, true);
        }
