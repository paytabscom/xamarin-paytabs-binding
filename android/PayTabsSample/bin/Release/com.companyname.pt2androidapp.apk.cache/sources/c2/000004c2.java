...
public final class CanvasKt {
    ...
    public static final void withTranslation(Canvas withTranslation, float f2, float f3, Function1<? super Canvas, Unit> block) {
        Intrinsics.checkNotNullParameter(withTranslation, "$this$withTranslation");
        Intrinsics.checkNotNullParameter(block, "block");
        int save = withTranslation.save();
        withTranslation.translate(f2, f3);
    ...
    public static final void withRotation(Canvas withRotation, float f2, float f3, float f4, Function1<? super Canvas, Unit> block) {
        Intrinsics.checkNotNullParameter(withRotation, "$this$withRotation");
        Intrinsics.checkNotNullParameter(block, "block");
        int save = withRotation.save();
        withRotation.rotate(f2, f3, f4);
    ...
    public static final void withScale(Canvas withScale, float f2, float f3, float f4, float f5, Function1<? super Canvas, Unit> block) {
        Intrinsics.checkNotNullParameter(withScale, "$this$withScale");
        Intrinsics.checkNotNullParameter(block, "block");
        int save = withScale.save();
        withScale.scale(f2, f3, f4, f5);
    ...
    public static final void withSkew(Canvas withSkew, float f2, float f3, Function1<? super Canvas, Unit> block) {
        Intrinsics.checkNotNullParameter(withSkew, "$this$withSkew");
        Intrinsics.checkNotNullParameter(block, "block");
        int save = withSkew.save();
        withSkew.skew(f2, f3);
    ...
    public static final void withClip(Canvas withClip, int i2, int i3, int i4, int i5, Function1<? super Canvas, Unit> block) {
        Intrinsics.checkNotNullParameter(withClip, "$this$withClip");
        Intrinsics.checkNotNullParameter(block, "block");
        int save = withClip.save();
    ...
    public static final void withClip(Canvas withClip, float f2, float f3, float f4, float f5, Function1<? super Canvas, Unit> block) {
        Intrinsics.checkNotNullParameter(withClip, "$this$withClip");
        Intrinsics.checkNotNullParameter(block, "block");
        int save = withClip.save();
