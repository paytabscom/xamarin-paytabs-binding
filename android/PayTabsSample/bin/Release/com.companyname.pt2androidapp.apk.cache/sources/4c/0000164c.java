...
public class MediaCas_EventListenerImplementor implements IGCUserPeer, MediaCas.EventListener {
    ...
    private native void n_onEvent(MediaCas mediaCas, int i2, int i3, byte[] bArr);

    private native void n_onPluginStatusUpdate(MediaCas mediaCas, int i2, int i3);

    private native void n_onResourceLost(MediaCas mediaCas);

    private native void n_onSessionEvent(MediaCas mediaCas, MediaCas.Session session, int i2, int i3, byte[] bArr);
    ...
    public void onEvent(MediaCas mediaCas, int i2, int i3, byte[] bArr) {
        n_onEvent(mediaCas, i2, i3, bArr);
    }

    @Override // android.media.MediaCas.EventListener
    public void onPluginStatusUpdate(MediaCas mediaCas, int i2, int i3) {
        n_onPluginStatusUpdate(mediaCas, i2, i3);
    }
    ...
    @Override // android.media.MediaCas.EventListener
    public void onSessionEvent(MediaCas mediaCas, MediaCas.Session session, int i2, int i3, byte[] bArr) {
        n_onSessionEvent(mediaCas, session, i2, i3, bArr);
    }
