    ...
    public static void LoadApplication(Context context, ApplicationInfo applicationInfo, String[] strArr) {
        synchronized (lock) {
            ...
            if (!initialized) {
                ...
                if (Build.VERSION.SDK_INT >= 21 && applicationInfo.splitSourceDirs != null && applicationInfo.splitSourceDirs.length > 1) {
                    z2 = true;
                }
                boolean z3 = z2;
                if (BuildConfig.Debug) {
                    System.loadLibrary("xamarin-debug-app-helper");
                    DebugRuntime.init(strArr, nativeLibraryPath2, strArr2, z3);
                } else {
                ...
                Runtime.initInternal(str, strArr, nativeLibraryPath2, strArr2, classLoader, MonoPackageManager_Resources.Assemblies, Build.VERSION.SDK_INT, isEmulator(), z3);
