...
public enum b {
    ...
    private static final int[] f280u = {4, 10};

    /* renamed from: v  reason: collision with root package name */
    private static final int[] f281v = {4, 8, 12};

    /* renamed from: a  reason: collision with root package name */
    private final Pattern f283a;

    /* renamed from: b  reason: collision with root package name */
    private final Pattern f284b;
    ...
    b(String str, int i2, int i3, int i4, int i5, int i6, String str2) {
        this.f283a = Pattern.compile(str);
        this.f284b = str2 == null ? null : Pattern.compile(str2);
        this.f285c = i2;
        this.f286d = i3;
        this.f287e = i4;
        this.f288f = i5;
    ...
    public boolean e(String str) {
        int length;
        Pattern pattern;
        if (!TextUtils.isEmpty(str) && TextUtils.isDigitsOnly(str) && (length = str.length()) >= this.f286d && length <= this.f287e) {
            if (this.f283a.matcher(str).matches() || (pattern = this.f284b) == null || pattern.matcher(str).matches()) {
                return d(str);
            }
            return false;
        }
