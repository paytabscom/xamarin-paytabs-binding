...
public final class TypeReference implements KType {
    ...
    private final String asString() {
        ...
        return arrayClassName + (getArguments().isEmpty() ? "" : CollectionsKt.joinToString$default(getArguments(), ", ", "<", ">", 0, null, new TypeReference$asString$args$1(this), 24, null)) + (isMarkedNullable() ? "?" : "");
    }
