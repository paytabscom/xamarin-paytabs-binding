...
public class AudioEffect_OnEnableStatusChangeListenerImplementor implements IGCUserPeer, AudioEffect.OnEnableStatusChangeListener {
    ...
    private native void n_onEnableStatusChange(AudioEffect audioEffect, boolean z2);
    ...
    public void onEnableStatusChange(AudioEffect audioEffect, boolean z2) {
        n_onEnableStatusChange(audioEffect, z2);
    }
