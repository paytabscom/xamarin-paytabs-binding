...
public final class ConcurrentWeakMap<K, V> extends AbstractMutableMap<K, V> {
    ...
    public V put(K k2, V v2) {
        Symbol symbol;
        V v3 = (V) Core.putImpl$default((Core) this.core, k2, v2, null, 4, null);
    ...
    public V remove(Object obj) {
        Symbol symbol;
        if (obj != 0) {
            V v2 = (V) Core.putImpl$default((Core) this.core, obj, null, null, 4, null);
            symbol = ConcurrentWeakMapKt.REHASH;
            if (v2 == symbol) {
    ...
    private final synchronized V putSynchronized(K k2, V v2) {
        ...
        while (true) {
            v3 = (V) Core.putImpl$default(core, k2, v2, null, 4, null);
            symbol = ConcurrentWeakMapKt.REHASH;
            if (v3 == symbol) {
                core = core.rehash();
                this.core = core;
            ...
            private final void findNext() {
                ...
                while (true) {
                    ...
                    if (hashedWeakRef != null && (k2 = (K) hashedWeakRef.get()) != null) {
                        this.key = k2;
                        V v2 = (V) Core.this.values.get(this.index);
                        if (v2 instanceof Marked) {
                            v2 = (V) ((Marked) v2).ref;
                        }
                        if (v2 != null) {
                            this.value = v2;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* compiled from: ConcurrentWeakMap.kt */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010'\n\u0002\b\u000b\b\u0002\u0018\u0000*\u0004\b\u0002\u0010\u0001*\u0004\b\u0003\u0010\u00022\u000e\u0012\u0004\u0012\u0002H\u0001\u0012\u0004\u0012\u0002H\u00020\u0003B\u0015\u0012\u0006\u0010\u0004\u001a\u00028\u0002\u0012\u0006\u0010\u0005\u001a\u00028\u0003¢\u0006\u0002\u0010\u0006J\u0015\u0010\u000b\u001a\u00028\u00032\u0006\u0010\f\u001a\u00028\u0003H\u0016¢\u0006\u0002\u0010\rR\u0016\u0010\u0004\u001a\u00028\u0002X\u0096\u0004¢\u0006\n\n\u0002\u0010\t\u001a\u0004\b\u0007\u0010\bR\u0016\u0010\u0005\u001a\u00028\u0003X\u0096\u0004¢\u0006\n\n\u0002\u0010\t\u001a\u0004\b\n\u0010\b¨\u0006\u000e"}, d2 = {"Lkotlinx/coroutines/debug/internal/ConcurrentWeakMap$Entry;", "K", "V", "", "key", "value", "(Ljava/lang/Object;Ljava/lang/Object;)V", "getKey", "()Ljava/lang/Object;", "Ljava/lang/Object;", "getValue", "setValue", "newValue", "(Ljava/lang/Object;)Ljava/lang/Object;", "kotlinx-coroutines-core"}, k = 1, mv = {1, 4, 2})
    /* loaded from: classes.dex */
