...
public class ShapePath {
    ...
    public void lineTo(float f2, float f3) {
        ...
        pathLineOperation.f58x = f2;
        pathLineOperation.f59y = f3;
    ...
    static class LineShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i2, Canvas canvas) {
            RectF rectF = new RectF(0.0f, 0.0f, (float) Math.hypot(this.operation.f59y - this.startY, this.operation.f58x - this.startX), 0.0f);
        ...
        float getAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation.f59y - this.startY) / (this.operation.f58x - this.startX)));
        }
    }
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        public void applyToPath(Matrix matrix, Path path) {
            ...
            path.lineTo(this.f58x, this.f59y);
