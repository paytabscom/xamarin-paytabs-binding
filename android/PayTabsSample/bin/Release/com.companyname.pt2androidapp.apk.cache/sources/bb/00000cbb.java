...
public class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    private void addRippleEffectOnOutlinedLayout(AutoCompleteTextView autoCompleteTextView, int i2, int[][] iArr, MaterialShapeDrawable materialShapeDrawable) {
    ...
    private void addRippleEffectOnFilledLayout(AutoCompleteTextView autoCompleteTextView, int i2, int[][] iArr, MaterialShapeDrawable materialShapeDrawable) {
