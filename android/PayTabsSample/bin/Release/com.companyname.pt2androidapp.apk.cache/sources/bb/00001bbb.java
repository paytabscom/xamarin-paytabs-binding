...
public class DisplayManager_DisplayListenerImplementor implements IGCUserPeer, DisplayManager.DisplayListener {
    ...
    private native void n_onDisplayAdded(int i2);

    private native void n_onDisplayChanged(int i2);

    private native void n_onDisplayRemoved(int i2);
    ...
    public void onDisplayChanged(int i2) {
        n_onDisplayChanged(i2);
    }

    @Override // android.hardware.display.DisplayManager.DisplayListener
    public void onDisplayRemoved(int i2) {
        n_onDisplayRemoved(i2);
    }
