...
public class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    */
    ...
    public boolean hasWindowFeature(int i2) {
        ...
        if (sanitizeWindowFeatureId == 1) {
            ...
            z2 = sanitizeWindowFeatureId != 109 ? false : this.mOverlayActionBar;
        }
    ...
    */
    ...
    public View createView(View view, String str, Context context, AttributeSet attributeSet) {
        ...
        return this.mAppCompatViewInflater.createView(view, str, context, attributeSet, z2, z4, true, VectorEnabledTintResources.shouldBeUsed());
    }
    ...
    private void openPanel(PanelFeatureState panelFeatureState, KeyEvent keyEvent) {
        ...
        if (windowManager != null && preparePanel(panelFeatureState, keyEvent)) {
            if (panelFeatureState.decorView == null || panelFeatureState.refreshDecorView) {
                ...
                WindowManager.LayoutParams layoutParams3 = new WindowManager.LayoutParams(i2, -2, panelFeatureState.f6x, panelFeatureState.f7y, PointerIconCompat.TYPE_HAND, 8519680, -3);
            ...
            i2 = -2;
            panelFeatureState.isHandled = false;
            WindowManager.LayoutParams layoutParams32 = new WindowManager.LayoutParams(i2, -2, panelFeatureState.f6x, panelFeatureState.f7y, PointerIconCompat.TYPE_HAND, 8519680, -3);
    ...
    private boolean performPanelShortcut(PanelFeatureState panelFeatureState, int i2, KeyEvent keyEvent, int i3) {
        ...
        if (z2 && (i3 & 1) == 0 && this.mDecorContentParent == null) {
            closePanel(panelFeatureState, true);
        }
        return z2;
    }
    ...
    private boolean applyDayNight(boolean z2) {
        ...
        boolean updateForNightMode = updateForNightMode(mapNightMode(this.mContext, calculateNightMode), z2);
    ...
    int mapNightMode(Context context, int i2) {
        if (i2 != -100) {
            if (i2 != -1) {
                if (i2 == 0) {
    ...
    public final class PanelMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public void onCloseMenu(MenuBuilder menuBuilder, boolean z2) {
            ...
            if (findMenuPanel != null) {
                ...
                AppCompatDelegateImpl.this.closePanel(findMenuPanel, z2);
            }
        }
