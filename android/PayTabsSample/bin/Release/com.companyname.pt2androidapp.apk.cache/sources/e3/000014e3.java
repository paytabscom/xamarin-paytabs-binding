...
public final class LintKt {
    ...
    private static final <T> Flow<T> m1427catch(SharedFlow<? extends T> sharedFlow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        Objects.requireNonNull(sharedFlow, "null cannot be cast to non-null type kotlinx.coroutines.flow.Flow<T>");
        return FlowKt.m1421catch(sharedFlow, function3);
    }
