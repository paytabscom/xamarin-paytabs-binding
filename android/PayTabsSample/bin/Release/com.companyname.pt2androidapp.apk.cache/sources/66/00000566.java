...
public final class PathKt {
    ...
    public static final Path plus(Path path, Path p2) {
        Intrinsics.checkNotNullParameter(path, "<this>");
    ...
    public static final Path minus(Path path, Path p2) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(p2, "p");
        Path path2 = new Path(path);
    ...
    public static final Path and(Path path, Path p2) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(p2, "p");
        Path path2 = new Path();
    ...
    public static final Path xor(Path path, Path p2) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(p2, "p");
        Path path2 = new Path(path);
    ...
    public static final Path or(Path path, Path p2) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(p2, "p");
        Path path2 = new Path(path);
        path2.op(p2, Path.Op.UNION);
