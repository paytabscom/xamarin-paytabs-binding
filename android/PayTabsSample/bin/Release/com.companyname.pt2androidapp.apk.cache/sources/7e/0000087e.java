...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    public void setMeasuredDimension(Rect rect, int i2, int i3) {
        ...
        if (this.mOrientation == 1) {
            ...
            chooseSize = chooseSize(i2, iArr[iArr.length - 1] + paddingLeft, getMinimumWidth());
        } else {
            chooseSize = chooseSize(i2, rect.width() + paddingLeft, getMinimumWidth());
            int[] iArr2 = this.mCachedBorders;
            chooseSize2 = chooseSize(i3, iArr2[iArr2.length - 1] + paddingTop, getMinimumHeight());
        }
    ...
    */
    ...
    private void measureChild(View view, int i2, boolean z2) {
        ...
        if (this.mOrientation == 1) {
            i4 = getChildMeasureSpec(spaceForSpanRange, i2, i6, layoutParams.width, false);
            i3 = getChildMeasureSpec(this.mOrientationHelper.getTotalSpace(), getHeightMode(), i5, layoutParams.height, true);
        } else {
            int childMeasureSpec = getChildMeasureSpec(spaceForSpanRange, i2, i5, layoutParams.height, false);
            int childMeasureSpec2 = getChildMeasureSpec(this.mOrientationHelper.getTotalSpace(), getWidthMode(), i6, layoutParams.width, true);
            i3 = childMeasureSpec;
            i4 = childMeasureSpec2;
        }
        measureChildWithDecorationsAndMargin(view, i4, i3, z2);
    }
