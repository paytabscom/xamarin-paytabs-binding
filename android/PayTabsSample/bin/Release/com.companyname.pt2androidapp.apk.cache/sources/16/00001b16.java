...
public final class CoroutineScheduler implements Executor, Closeable {
    ...
    private final boolean tryCreateWorker(long j2) {
        if (RangesKt.coerceAtLeast(((int) (2097151 & j2)) - ((int) ((j2 & BLOCKING_MASK) >> 21)), 0) < this.corePoolSize) {
    ...
    private final int createNewWorker() {
        synchronized (this.workers) {
            ...
            int coerceAtLeast = RangesKt.coerceAtLeast(i2 - ((int) ((j2 & BLOCKING_MASK) >> 21)), 0);
    ...
    public final class Worker extends Thread {
        ...
        private final Task trySteal(boolean z2) {
            long tryStealFrom;
            if (DebugKt.getASSERTIONS_ENABLED()) {
                if (!(this.localQueue.getSize$kotlinx_coroutines_core() == 0)) {
                    throw new AssertionError();
