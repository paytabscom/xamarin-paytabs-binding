...
public class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public boolean flagActionItems() {
        ...
        if (actionMenuPresenter.mReserveOverflow && (z2 || i10 + i9 > i7)) {
            i7--;
        }
        int i12 = i7 - i9;
        ...
        while (i14 < i2) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                ...
                boolean z4 = (i12 > 0 || z3) && i8 > 0 && (!actionMenuPresenter.mStrictWidthLimit || i4 > 0);
                boolean z5 = z4;
                i5 = i2;
                if (z4) {
                    ...
                    z4 = z6 & (!actionMenuPresenter.mStrictWidthLimit ? i8 + i15 <= 0 : i8 < 0);
                }
                if (z4 && groupId2 != 0) {
