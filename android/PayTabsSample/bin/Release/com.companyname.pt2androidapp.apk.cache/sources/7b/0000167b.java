...
public class WifiManager_SuggestionConnectionStatusListenerImplementor implements IGCUserPeer, WifiManager.SuggestionConnectionStatusListener {
    ...
    private native void n_onConnectionStatus(WifiNetworkSuggestion wifiNetworkSuggestion, int i2);
    ...
    public void onConnectionStatus(WifiNetworkSuggestion wifiNetworkSuggestion, int i2) {
        n_onConnectionStatus(wifiNetworkSuggestion, i2);
    }
