...
public final class DeepRecursiveKt {
    ...
    public static final <T, R> R invoke(DeepRecursiveFunction<T, R> invoke, T t2) {
        Intrinsics.checkNotNullParameter(invoke, "$this$invoke");
        return (R) new DeepRecursiveScopeImpl(invoke.getBlock$kotlin_stdlib(), t2).runCallLoop();
    }
