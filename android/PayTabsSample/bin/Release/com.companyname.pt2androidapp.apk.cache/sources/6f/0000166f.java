...
public class Virtualizer_OnParameterChangeListenerImplementor implements IGCUserPeer, Virtualizer.OnParameterChangeListener {
    ...
    private native void n_onParameterChange(Virtualizer virtualizer, int i2, int i3, short s2);
    ...
    public void onParameterChange(Virtualizer virtualizer, int i2, int i3, short s2) {
        n_onParameterChange(virtualizer, i2, i3, s2);
    }
