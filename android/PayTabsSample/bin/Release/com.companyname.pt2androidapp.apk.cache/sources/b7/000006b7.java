...
public class AccessibilityDelegateCompat {
    ...
    public boolean performAccessibilityAction(View view, int i2, Bundle bundle) {
        ...
        if (!z2 && Build.VERSION.SDK_INT >= 16) {
            z2 = Api16Impl.performAccessibilityAction(this.mOriginalDelegate, view, i2, bundle);
        }
        return (z2 || i2 != R.id.accessibility_action_clickable_span || bundle == null) ? z2 : performClickableSpanAction(bundle.getInt(AccessibilityClickableSpanCompat.SPAN_ID, -1), view);
    }
    ...
    public static class Api16Impl {
        ...
        static boolean performAccessibilityAction(View.AccessibilityDelegate accessibilityDelegate, View view, int i2, Bundle bundle) {
