...
public final class CursorKt {
    public static final byte[] getBlobOrNull(Cursor getBlobOrNull, int i2) {
    ...
    public static final Double getDoubleOrNull(Cursor getDoubleOrNull, int i2) {
    ...
    public static final Float getFloatOrNull(Cursor getFloatOrNull, int i2) {
    ...
    public static final Integer getIntOrNull(Cursor getIntOrNull, int i2) {
    ...
    public static final Long getLongOrNull(Cursor getLongOrNull, int i2) {
    ...
    public static final Short getShortOrNull(Cursor getShortOrNull, int i2) {
    ...
    public static final String getStringOrNull(Cursor getStringOrNull, int i2) {
