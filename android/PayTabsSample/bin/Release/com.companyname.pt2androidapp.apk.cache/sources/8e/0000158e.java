    ...
    */
    ...
    public final class Worker extends Thread {
        ...
        private final void tryTerminateWorker() {
            synchronized (CoroutineScheduler.this.workers) {
                ...
                if (workerCtl$FU.compareAndSet(this, -1, 1)) {
                    ...
                    setIndexInArray(0);
                    CoroutineScheduler.this.parkedWorkersStackTopUpdate(this, i2, 0);
                    ...
                    if (andDecrement != i2) {
                        ...
                        CoroutineScheduler.this.parkedWorkersStackTopUpdate(worker2, andDecrement, i2);
                    }
        ...
        private final Task trySteal(boolean z2) {
            ...
            int nextInt = nextInt(createdWorkers);
            long j2 = Long.MAX_VALUE;
            for (int i2 = 0; i2 < createdWorkers; i2++) {
                nextInt++;
                if (nextInt > createdWorkers) {
                    nextInt = 1;
                }
                Worker worker = CoroutineScheduler.this.workers.get(nextInt);
