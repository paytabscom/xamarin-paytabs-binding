...
public class CollectionsKt__CollectionsKt extends CollectionsKt__CollectionsJVMKt {
    ...
    private static final <E> List<E> buildList(int i2, Function1<? super List<E>, Unit> function1) {
    ...
    public static /* synthetic */ int binarySearch$default(List list, Comparable comparable, int i2, int i3, int i4, Object obj) {
        ...
        return CollectionsKt.binarySearch(list, comparable, i2, i3);
    }

    public static final <T extends Comparable<? super T>> int binarySearch(List<? extends T> binarySearch, T t2, int i2, int i3) {
        Intrinsics.checkNotNullParameter(binarySearch, "$this$binarySearch");
        rangeCheck$CollectionsKt__CollectionsKt(binarySearch.size(), i2, i3);
        int i4 = i3 - 1;
        while (i2 <= i4) {
            int i5 = (i2 + i4) >>> 1;
            int compareValues = ComparisonsKt.compareValues(binarySearch.get(i5), t2);
            if (compareValues < 0) {
                i2 = i5 + 1;
    ...
    public static final <T> int binarySearch(List<? extends T> binarySearch, T t2, Comparator<? super T> comparator, int i2, int i3) {
        Intrinsics.checkNotNullParameter(binarySearch, "$this$binarySearch");
        ...
        while (i2 <= i4) {
            int i5 = (i2 + i4) >>> 1;
            int compare = comparator.compare((T) binarySearch.get(i5), t2);
            if (compare < 0) {
                i2 = i5 + 1;
            } else if (compare <= 0) {
                return i5;
    ...
    public static /* synthetic */ int binarySearchBy$default(List binarySearchBy, Comparable comparable, int i2, int i3, Function1 selector, int i4, Object obj) {
        ...
        return CollectionsKt.binarySearch(binarySearchBy, i2, i3, new CollectionsKt__CollectionsKt$binarySearchBy$1(selector, comparable));
    }
    ...
    public static final <T, K extends Comparable<? super K>> int binarySearchBy(List<? extends T> binarySearchBy, K k2, int i2, int i3, Function1<? super T, ? extends K> selector) {
        Intrinsics.checkNotNullParameter(binarySearchBy, "$this$binarySearchBy");
        Intrinsics.checkNotNullParameter(selector, "selector");
        return CollectionsKt.binarySearch(binarySearchBy, i2, i3, new CollectionsKt__CollectionsKt$binarySearchBy$1(selector, k2));
    }
