...
public final class SparseArrayKt {
    ...
    public static final <T> void set(SparseArrayCompat<T> receiver$0, int i2, T t2) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
    ...
    public static final <T> T getOrDefault(SparseArrayCompat<T> receiver$0, int i2, T t2) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        return receiver$0.get(i2, t2);
    }

    public static final <T> T getOrElse(SparseArrayCompat<T> receiver$0, int i2, Function0<? extends T> defaultValue) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
    ...
    public static final <T> boolean remove(SparseArrayCompat<T> receiver$0, int i2, T t2) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
