...
public final class UShortArrayKt {
    ...
    private static final short[] m367ushortArrayOfrL5Bavg(short... sArr) {
        return sArr;
    }
    ...
    private static final short[] UShortArray(int i2, Function1<? super Integer, UShort> function1) {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            sArr[i3] = function1.invoke(Integer.valueOf(i3)).m348unboximpl();
        }
        return UShortArray.m351constructorimpl(sArr);
    }
}