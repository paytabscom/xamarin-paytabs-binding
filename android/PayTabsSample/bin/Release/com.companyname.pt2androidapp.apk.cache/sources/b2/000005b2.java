...
public final class SparseBooleanArrayKt {
    ...
    public static final boolean contains(SparseBooleanArray contains, int i2) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.indexOfKey(i2) >= 0;
    }

    public static final void set(SparseBooleanArray set, int i2, boolean z2) {
    ...
    public static final boolean containsKey(SparseBooleanArray containsKey, int i2) {
    ...
    public static final boolean getOrDefault(SparseBooleanArray getOrDefault, int i2, boolean z2) {
        Intrinsics.checkNotNullParameter(getOrDefault, "$this$getOrDefault");
        return getOrDefault.get(i2, z2);
    }

    public static final boolean getOrElse(SparseBooleanArray getOrElse, int i2, Function0<Boolean> defaultValue) {
    ...
    public static final boolean remove(SparseBooleanArray remove, int i2, boolean z2) {
