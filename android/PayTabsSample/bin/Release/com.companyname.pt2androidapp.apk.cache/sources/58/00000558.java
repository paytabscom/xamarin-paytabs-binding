...
public final class CanvasKt {
    ...
    public static final void withTranslation(Canvas canvas, float f2, float f3, Function1<? super Canvas, Unit> block) {
        Intrinsics.checkNotNullParameter(canvas, "<this>");
        Intrinsics.checkNotNullParameter(block, "block");
        int save = canvas.save();
        canvas.translate(f2, f3);
    ...
    public static final void withRotation(Canvas canvas, float f2, float f3, float f4, Function1<? super Canvas, Unit> block) {
        Intrinsics.checkNotNullParameter(canvas, "<this>");
        Intrinsics.checkNotNullParameter(block, "block");
        int save = canvas.save();
        canvas.rotate(f2, f3, f4);
    ...
    public static final void withScale(Canvas canvas, float f2, float f3, float f4, float f5, Function1<? super Canvas, Unit> block) {
        Intrinsics.checkNotNullParameter(canvas, "<this>");
        Intrinsics.checkNotNullParameter(block, "block");
        int save = canvas.save();
        canvas.scale(f2, f3, f4, f5);
    ...
    public static final void withSkew(Canvas canvas, float f2, float f3, Function1<? super Canvas, Unit> block) {
        Intrinsics.checkNotNullParameter(canvas, "<this>");
        Intrinsics.checkNotNullParameter(block, "block");
        int save = canvas.save();
        canvas.skew(f2, f3);
    ...
    public static final void withClip(Canvas canvas, int i2, int i3, int i4, int i5, Function1<? super Canvas, Unit> block) {
        Intrinsics.checkNotNullParameter(canvas, "<this>");
        Intrinsics.checkNotNullParameter(block, "block");
        int save = canvas.save();
    ...
    public static final void withClip(Canvas canvas, float f2, float f3, float f4, float f5, Function1<? super Canvas, Unit> block) {
        Intrinsics.checkNotNullParameter(canvas, "<this>");
        Intrinsics.checkNotNullParameter(block, "block");
        int save = canvas.save();
