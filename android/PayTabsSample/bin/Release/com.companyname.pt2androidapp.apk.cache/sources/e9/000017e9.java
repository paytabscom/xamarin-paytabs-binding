...
public abstract class AbstractLongTimeSource implements TimeSource {
    ...
    private static final class LongTimeMark extends TimeMark {
        ...
        public long mo1317elapsedNowUwyO8pc() {
            return Duration.m1361minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.TimeMark
        /* renamed from: plus-LRDsOJo */
        public TimeMark mo1318plusLRDsOJo(long j2) {
            return new LongTimeMark(this.startedAt, this.timeSource, Duration.m1362plusLRDsOJo(this.offset, j2));
        }
    }

    @Override // kotlin.time.TimeSource
    public TimeMark markNow() {
        return new LongTimeMark(read(), this, Duration.Companion.m1387getZEROUwyO8pc(), null);
    }
}