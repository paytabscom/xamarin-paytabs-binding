...
public final class UIntArray implements Collection<UInt>, KMappedMarker {
    ...
    public static boolean m193equalsimpl(int[] iArr, Object obj) {
        return (obj instanceof UIntArray) && Intrinsics.areEqual(iArr, ((UIntArray) obj).m204unboximpl());
    }
    ...
    public boolean m202addWZ4Q5Ns(int i2) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public boolean m203containsWZ4Q5Ns(int i2) {
        return m191containsWZ4Q5Ns(this.storage, i2);
    }

    @Override // java.util.Collection
    public boolean containsAll(Collection<? extends Object> collection) {
        return m192containsAllimpl(this.storage, collection);
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UInt) {
            return m203containsWZ4Q5Ns(((UInt) obj).m187unboximpl());
        }
        return false;
    }
    ...
    public static int[] m189constructorimpl(int i2) {
        return m190constructorimpl(new int[i2]);
    }

    /* renamed from: get-pVg5ArA  reason: not valid java name */
    public static final int m195getpVg5ArA(int[] iArr, int i2) {
        return UInt.m136constructorimpl(iArr[i2]);
    }

    /* renamed from: set-VXSXFK8  reason: not valid java name */
    public static final void m200setVXSXFK8(int[] iArr, int i2, int i3) {
        iArr[i2] = i3;
    }
    ...
    /* renamed from: contains-WZ4Q5Ns  reason: not valid java name */
    public static boolean m191containsWZ4Q5Ns(int[] iArr, int i2) {
    ...
    public static boolean m192containsAllimpl(int[] iArr, Collection<UInt> elements) {
        ...
        if (!collection.isEmpty()) {
            for (Object obj : collection) {
                if ((obj instanceof UInt) && ArraysKt.contains(iArr, ((UInt) obj).m187unboximpl())) {
                    z2 = true;
                    continue;
                } else {
                    z2 = false;
