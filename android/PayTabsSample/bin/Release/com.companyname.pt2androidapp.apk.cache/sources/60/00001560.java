...
public class LockFreeLinkedListNode {
    ...
    public static abstract class CondAddOp extends AtomicOp<LockFreeLinkedListNode> {
        ...
        public void complete(LockFreeLinkedListNode lockFreeLinkedListNode, Object obj) {
            ...
            if (lockFreeLinkedListNode2 != null && LockFreeLinkedListNode._next$FU.compareAndSet(lockFreeLinkedListNode, this, lockFreeLinkedListNode2) && z2) {
    ...
    public final <T extends LockFreeLinkedListNode> AddLastDesc<T> describeAddLast(T t2) {
    ...
    public static class AddLastDesc<T extends LockFreeLinkedListNode> extends AbstractAtomicDesc {
        ...
        public AddLastDesc(LockFreeLinkedListNode lockFreeLinkedListNode, T t2) {
            ...
            if (DebugKt.getASSERTIONS_ENABLED()) {
                if (!(t2._next == t2 && ((LockFreeLinkedListNode) t2._prev) == t2)) {
        ...
        */
        public final java.lang.Object prepare(kotlinx.coroutines.internal.AtomicOp<?> r7) {
            ...
            */
            ...
            /*
                ...
                if (r4 == 0) goto L0
                java.lang.Object r4 = r3.perform(r0)     // Catch: java.lang.Throwable -> L6c
                java.lang.Object r5 = kotlinx.coroutines.internal.LockFreeLinkedList_commonKt.REMOVE_PREPARED     // Catch: java.lang.Throwable -> L6c
                if (r4 != r5) goto L55
                goto L0
            L55:
                boolean r7 = kotlinx.coroutines.DebugKt.getASSERTIONS_ENABLED()     // Catch: java.lang.Throwable -> L6c
                if (r7 == 0) goto L6b
                if (r4 != 0) goto L5f
                r7 = 1
                goto L60
        ...
        public final void complete(AtomicOp<?> atomicOp, Object obj) {
            ...
            if (affectedNode == null) {
                if (DebugKt.getASSERTIONS_ENABLED() && !(!z2)) {
                    throw new AssertionError();
                }
                return;
            }
            ...
            if (LockFreeLinkedListNode._next$FU.compareAndSet(affectedNode, atomicOp, z2 ? updatedNext(affectedNode, originalNext) : originalNext) && z2) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:28:0x004e, code lost:
        if (kotlinx.coroutines.internal.LockFreeLinkedListNode._next$FU.compareAndSet(r4, r3, ((kotlinx.coroutines.internal.Removed) r5).ref) != false) goto L23;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
