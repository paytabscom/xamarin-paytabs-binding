...
public final class DrawableCompat {
    ...
    public static void setAutoMirrored(Drawable drawable, boolean z2) {
        if (Build.VERSION.SDK_INT >= 19) {
            Api19Impl.setAutoMirrored(drawable, z2);
        }
    }
    ...
    public static class Api19Impl {
        ...
        static void setAutoMirrored(Drawable drawable, boolean z2) {
        ...
        static Drawable getChild(DrawableContainer.DrawableContainerState drawableContainerState, int i2) {
