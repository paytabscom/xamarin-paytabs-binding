...
public final class LongSparseArrayKt {
    ...
    public static final <T> void set(LongSparseArray<T> receiver$0, long j2, T t2) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
    ...
    public static final <T> T getOrDefault(LongSparseArray<T> receiver$0, long j2, T t2) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        return receiver$0.get(j2, t2);
    }

    public static final <T> T getOrElse(LongSparseArray<T> receiver$0, long j2, Function0<? extends T> defaultValue) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
    ...
    public static final <T> boolean remove(LongSparseArray<T> receiver$0, long j2, T t2) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
