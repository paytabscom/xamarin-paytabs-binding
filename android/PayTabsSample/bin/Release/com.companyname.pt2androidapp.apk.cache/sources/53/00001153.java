...
public final class FieldSet<T extends FieldDescriptorLite<T>> {
    ...
    public static <T extends FieldDescriptorLite<T>> SmallSortedMap<T, Object> cloneAllFieldsMap(SmallSortedMap<T, Object> fields, boolean copyList) {
        ...
        for (int i2 = 0; i2 < fields.getNumArrayEntries(); i2++) {
            cloneFieldEntry(newFieldMap, fields.getArrayEntryAt(i2), copyList);
        }
    ...
    public void setField(final T descriptor, Object value) {
        if (descriptor.isRepeated()) {
            ...
            for (Object obj : arrayList) {
                verifyType(descriptor.getLiteType(), obj);
            }
            value = arrayList;
        } else {
    ...
    public static void writeField(final FieldDescriptorLite<?> descriptor, final Object value, final CodedOutputStream output) throws IOException {
        ...
        if (descriptor.isRepeated()) {
            ...
            if (descriptor.isPacked()) {
                ...
                int i2 = 0;
                for (Object obj : list) {
                    i2 += computeElementSizeNoTag(liteType, obj);
                }
                output.writeRawVarint32(i2);
    ...
    public static int computeFieldSize(final FieldDescriptorLite<?> descriptor, final Object value) {
        ...
        if (descriptor.isRepeated()) {
            ...
            for (Object obj2 : (List) value) {
                i2 += computeElementSize(liteType, number, obj2);
            }
            return i2;
        }
    ...
    static final class Builder<T extends FieldDescriptorLite<T>> {
        ...
        private static <T extends FieldDescriptorLite<T>> void replaceBuilders(SmallSortedMap<T, Object> fieldMap) {
            for (int i2 = 0; i2 < fieldMap.getNumArrayEntries(); i2++) {
                replaceBuilders(fieldMap.getArrayEntryAt(i2));
            }
