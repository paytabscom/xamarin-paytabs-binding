...
public class AccessibilityDelegateCompat {
    ...
    public boolean performAccessibilityAction(View view, int i2, Bundle bundle) {
        ...
        if (!z2 && Build.VERSION.SDK_INT >= 16) {
            z2 = this.mOriginalDelegate.performAccessibilityAction(view, i2, bundle);
        }
        return (z2 || i2 != R.id.accessibility_action_clickable_span) ? z2 : performClickableSpanAction(bundle.getInt(AccessibilityClickableSpanCompat.SPAN_ID, -1), view);
    }
