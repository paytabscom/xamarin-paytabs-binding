...
public class c {
    ...
    private static final c f278b = new c(Calendar.getInstance());

    /* renamed from: a  reason: collision with root package name */
    private final Calendar f279a;
    ...
    private int a() {
        return this.f279a.get(2) + 1;
    }

    public static boolean a(String str, String str2) {
        return f278b.b(str, str2);
    }

    private int b() {
        return this.f279a.get(1) % 100;
    }
