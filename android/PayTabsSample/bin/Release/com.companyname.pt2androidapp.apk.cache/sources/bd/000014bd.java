...
public final class ResultKt {
    ...
    private static final <R> Object runCatching(Function0<? extends R> function0) {
        try {
            ...
            return Result.m42constructorimpl(function0.invoke());
        } catch (Throwable th) {
    ...
    private static final <T, R> Object runCatching(T t2, Function1<? super T, ? extends R> function1) {
        try {
            Result.Companion companion = Result.Companion;
            return Result.m42constructorimpl(function1.invoke(t2));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            return Result.m42constructorimpl(createFailure(th));
        }
    ...
    private static final <R, T extends R> R getOrElse(Object obj, Function1<? super Throwable, ? extends R> function1) {
        ...
        return m45exceptionOrNullimpl == null ? obj : function1.invoke(m45exceptionOrNullimpl);
    }

    /* JADX WARN: Multi-variable type inference failed */
    private static final <R, T extends R> R getOrDefault(Object obj, R r2) {
        return Result.m48isFailureimpl(obj) ? r2 : obj;
    }
    ...
    private static final <R, T extends R> Object recover(Object obj, Function1<? super Throwable, ? extends R> function1) {
        ...
        Result.Companion companion = Result.Companion;
        return Result.m42constructorimpl(function1.invoke(m45exceptionOrNullimpl));
    }
    ...
    private static final <T> Object onFailure(Object obj, Function1<? super Throwable, Unit> function1) {
        Throwable m45exceptionOrNullimpl = Result.m45exceptionOrNullimpl(obj);
        if (m45exceptionOrNullimpl != null) {
            function1.invoke(m45exceptionOrNullimpl);
        }
        return obj;
    }
