...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public RecyclerView(Context context, AttributeSet attributeSet, int i2) {
        ...
        ViewCompat.saveAttributeDataForStyleable(this, context, R.styleable.RecyclerView, attributeSet, obtainStyledAttributes, i2, 0);
    ...
    */
    ...
    private void dispatchLayoutStep1() {
        ...
        if (this.mState.mRunPredictiveAnimations) {
            saveOldPositions();
            boolean z3 = this.mState.mStructureChanged;
    ...
    */
    ...
    public class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                recyclerView3.dispatchNestedScroll(i2, i3, i4, i5, null, 1, recyclerView3.mReusableIntPair);
    ...
    public final class Recycler {
        ...
        */
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public void addViewHolderToRecycledViewPool(ViewHolder viewHolder, boolean z2) {
        ...
        ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int i2, boolean z2) {
            ...
            if (!z2 && (findHiddenNonRemovedView = RecyclerView.this.mChildHelper.findHiddenNonRemovedView(i2)) != null) {
