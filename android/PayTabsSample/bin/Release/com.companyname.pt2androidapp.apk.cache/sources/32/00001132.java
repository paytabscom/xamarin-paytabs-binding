...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    private UIntProgression(int i2, int i3, int i4) {
        ...
        this.first = i2;
        this.last = UProgressionUtilKt.m1212getProgressionLastElementNkh28Cs(i2, i3, i4);
        this.step = i4;
    }

    /* renamed from: getFirst-pVg5ArA  reason: not valid java name */
    public final int m1226getFirstpVg5ArA() {
        return this.first;
    }

    /* renamed from: getLast-pVg5ArA  reason: not valid java name */
    public final int m1227getLastpVg5ArA() {
        return this.last;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append(UInt.m160toStringimpl(this.first));
            sb.append("..");
            sb.append(UInt.m160toStringimpl(this.last));
            sb.append(" step ");
            i2 = this.step;
        } else {
            sb = new StringBuilder();
    ...
    public static final class Companion {
        ...
        public final UIntProgression m1228fromClosedRangeNkh28Cs(int i2, int i3, int i4) {
