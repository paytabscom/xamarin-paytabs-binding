...
public final class ChannelFlowMerge<T> extends ChannelFlow<T> {
    ...
    public /* synthetic */ ChannelFlowMerge(Flow flow, int i2, EmptyCoroutineContext emptyCoroutineContext, int i3, BufferOverflow bufferOverflow, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(flow, i2, (i4 & 4) != 0 ? EmptyCoroutineContext.INSTANCE : emptyCoroutineContext, (i4 & 8) != 0 ? -2 : i3, (i4 & 16) != 0 ? BufferOverflow.SUSPEND : bufferOverflow);
    }
