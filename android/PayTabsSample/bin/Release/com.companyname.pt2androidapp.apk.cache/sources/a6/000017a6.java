...
public final class c {
    ...
    public static final class b extends Animation {
        ...
        @Override // android.view.animation.Animation
        protected void applyTransformation(float f2, Transformation transformation) {
            this.f565a.getLayoutParams().height = (f2 > 1.0f ? 1 : (f2 == 1.0f ? 0 : -1)) == 0 ? -2 : (int) (this.f566b * f2);
    ...
    public static final void a(final View view, long j2) {
        ...
        new Handler().postDelayed(new Runnable() { // from class: z.-$$Lambda$c$BnBeWVFR6FfFgpUf8RAQPIu-lRc
            ...
            public final void run() {
                c.m1454lambda$BnBeWVFR6FfFgpUf8RAQPIulRc(view);
            }
        }, j2);
    }
    ...
    public static /* synthetic */ void m1454lambda$BnBeWVFR6FfFgpUf8RAQPIulRc(View view) {
        b(view);
    }
