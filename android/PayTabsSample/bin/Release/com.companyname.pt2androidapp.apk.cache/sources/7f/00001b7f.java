...
public class Runtime {
    ...
    public static native int createNewContextWithData(String[] strArr, String[] strArr2, byte[][] bArr, String[] strArr3, ClassLoader classLoader, boolean z2);

    public static native void destroyContexts(int[] iArr);

    public static native void init(String str, String[] strArr, String str2, String[] strArr2, ClassLoader classLoader, String[] strArr3, String[] strArr4, String str3, int i2, String[] strArr5);

    public static native void initInternal(String str, String[] strArr, String str2, String[] strArr2, ClassLoader classLoader, String[] strArr3, int i2, boolean z2, boolean z3);
    ...
    public static native void switchToContext(int i2);
