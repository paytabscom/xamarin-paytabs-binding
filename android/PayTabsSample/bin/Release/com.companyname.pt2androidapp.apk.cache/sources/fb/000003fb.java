...
public class ConstraintSet {
    ...
    public void clone(ConstraintSet constraintSet) {
        ...
        for (Integer num : constraintSet.mConstraints.keySet()) {
            this.mConstraints.put(num, constraintSet.mConstraints.get(num).m7clone());
        }
    }
    ...
    public void connect(int i2, int i3, int i4, int i5, int i6) {
        ...
        switch (i3) {
            case 1:
                if (i5 == 1) {
                    constraint.layout.leftToLeft = i4;
                    constraint.layout.leftToRight = -1;
                } else if (i5 == 2) {
                    constraint.layout.leftToRight = i4;
            ...
            case 2:
                if (i5 == 1) {
                    constraint.layout.rightToLeft = i4;
                    constraint.layout.rightToRight = -1;
                } else if (i5 == 2) {
                    constraint.layout.rightToRight = i4;
            ...
            case 3:
                if (i5 == 3) {
                    constraint.layout.topToTop = i4;
                    constraint.layout.topToBottom = -1;
                    constraint.layout.baselineToBaseline = -1;
                } else if (i5 == 4) {
                    constraint.layout.topToBottom = i4;
            ...
            case 4:
                if (i5 == 4) {
                    constraint.layout.bottomToBottom = i4;
                    constraint.layout.bottomToTop = -1;
                    constraint.layout.baselineToBaseline = -1;
                } else if (i5 == 3) {
                    constraint.layout.bottomToTop = i4;
            ...
            case 5:
                if (i5 == 5) {
                    constraint.layout.baselineToBaseline = i4;
                    constraint.layout.bottomToBottom = -1;
                    constraint.layout.bottomToTop = -1;
                    constraint.layout.topToTop = -1;
                    constraint.layout.topToBottom = -1;
            ...
            case 6:
                if (i5 == 6) {
                    constraint.layout.startToStart = i4;
                    constraint.layout.startToEnd = -1;
                } else if (i5 == 7) {
                    constraint.layout.startToEnd = i4;
            ...
            case 7:
                if (i5 == 7) {
                    constraint.layout.endToEnd = i4;
                    constraint.layout.endToStart = -1;
                } else if (i5 == 6) {
                    constraint.layout.endToStart = i4;
    ...
    public void removeFromVerticalChain(int i2) {
        if (this.mConstraints.containsKey(Integer.valueOf(i2))) {
            Constraint constraint = this.mConstraints.get(Integer.valueOf(i2));
            int i3 = constraint.layout.topToBottom;
            int i4 = constraint.layout.bottomToTop;
            if (i3 != -1 || i4 != -1) {
                if (i3 != -1 && i4 != -1) {
                    connect(i3, 4, i4, 3, 0);
                    connect(i4, 3, i3, 4, 0);
                    ...
                    if (constraint.layout.bottomToBottom != -1) {
                        connect(i3, 4, constraint.layout.bottomToBottom, 4, 0);
                    } else if (constraint.layout.topToTop != -1) {
                        connect(i4, 3, constraint.layout.topToTop, 3, 0);
                    }
                }
            }
        }
    ...
    public void removeFromHorizontalChain(int i2) {
        if (this.mConstraints.containsKey(Integer.valueOf(i2))) {
            ...
            int i5 = constraint.layout.startToEnd;
            int i6 = constraint.layout.endToStart;
            if (i5 != -1 || i6 != -1) {
                if (i5 != -1 && i6 != -1) {
                    connect(i5, 7, i6, 6, 0);
                    connect(i6, 6, i3, 7, 0);
                    ...
                    if (constraint.layout.rightToRight != -1) {
                        ...
                        connect(i6, 6, constraint.layout.leftToLeft, 6, 0);
                    }
                }
            }
            clear(i2, 6);
