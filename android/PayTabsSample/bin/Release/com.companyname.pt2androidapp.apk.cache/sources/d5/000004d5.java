...
public final class RectKt {
    ...
    public static final Rect plus(Rect plus, Rect r2) {
    ...
    public static final RectF plus(RectF plus, RectF r2) {
        Intrinsics.checkNotNullParameter(plus, "$this$plus");
        Intrinsics.checkNotNullParameter(r2, "r");
    ...
    public static final Rect plus(Rect plus, int i2) {
        Intrinsics.checkNotNullParameter(plus, "$this$plus");
        Rect rect = new Rect(plus);
        rect.offset(i2, i2);
        return rect;
    ...
    public static final Region minus(Rect minus, Rect r2) {
    ...
    public static final Region minus(RectF minus, RectF r2) {
        Intrinsics.checkNotNullParameter(minus, "$this$minus");
        Intrinsics.checkNotNullParameter(r2, "r");
        Rect rect = new Rect();
        minus.roundOut(rect);
    ...
    public static final Rect minus(Rect minus, int i2) {
        Intrinsics.checkNotNullParameter(minus, "$this$minus");
    ...
    public static final Rect times(Rect times, int i2) {
    ...
    public static final Rect and(Rect and, Rect r2) {
    ...
    public static final RectF and(RectF and, RectF r2) {
        Intrinsics.checkNotNullParameter(and, "$this$and");
        Intrinsics.checkNotNullParameter(r2, "r");
    ...
    public static final Region xor(Rect xor, Rect r2) {
    ...
    public static final Region xor(RectF xor, RectF r2) {
        Intrinsics.checkNotNullParameter(xor, "$this$xor");
        Intrinsics.checkNotNullParameter(r2, "r");
        Rect rect = new Rect();
        xor.roundOut(rect);
    ...
    public static final boolean contains(Rect contains, Point p2) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        Intrinsics.checkNotNullParameter(p2, "p");
        return contains.contains(p2.x, p2.y);
    }

    public static final boolean contains(RectF contains, PointF p2) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        Intrinsics.checkNotNullParameter(p2, "p");
        return contains.contains(p2.x, p2.y);
    }
    ...
    public static final RectF transform(RectF transform, Matrix m2) {
    ...
    public static final RectF times(RectF times, int i2) {
        Intrinsics.checkNotNullParameter(times, "$this$times");
        float f2 = i2;
        RectF rectF = new RectF(times);
        rectF.top *= f2;
    ...
    public static final Rect or(Rect or, Rect r2) {
    ...
    public static final RectF or(RectF or, RectF r2) {
        Intrinsics.checkNotNullParameter(or, "$this$or");
        Intrinsics.checkNotNullParameter(r2, "r");
