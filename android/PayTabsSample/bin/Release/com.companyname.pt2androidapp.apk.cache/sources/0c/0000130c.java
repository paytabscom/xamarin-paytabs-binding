...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    static /* synthetic */ Object m1407receiveOrClosedWVj179g$suspendImpl(ChannelCoroutine channelCoroutine, Continuation continuation) {
        return channelCoroutine._channel.mo1406receiveOrClosedWVj179g(continuation);
    }
    ...
    public Object mo1406receiveOrClosedWVj179g(Continuation<? super ValueOrClosed<? extends E>> continuation) {
        return m1407receiveOrClosedWVj179g$suspendImpl(this, continuation);
    }
