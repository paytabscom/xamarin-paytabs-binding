...
public final class UByteArrayKt {
    ...
    private static final byte[] m107ubyteArrayOfGBYM_sE(byte... bArr) {
        return bArr;
    }
    ...
    private static final byte[] UByteArray(int i2, Function1<? super Integer, UByte> function1) {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            bArr[i3] = function1.invoke(Integer.valueOf(i3)).m88unboximpl();
        }
        return UByteArray.m91constructorimpl(bArr);
    }
}