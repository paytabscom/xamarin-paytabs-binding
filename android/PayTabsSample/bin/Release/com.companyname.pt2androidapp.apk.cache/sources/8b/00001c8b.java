...
public class SearchView_OnSuggestionListenerImplementor implements IGCUserPeer, SearchView.OnSuggestionListener {
    ...
    private native boolean n_onSuggestionClick(int i2);

    private native boolean n_onSuggestionSelect(int i2);
    ...
    public boolean onSuggestionClick(int i2) {
        return n_onSuggestionClick(i2);
    }

    @Override // android.widget.SearchView.OnSuggestionListener
    public boolean onSuggestionSelect(int i2) {
        return n_onSuggestionSelect(i2);
    }
