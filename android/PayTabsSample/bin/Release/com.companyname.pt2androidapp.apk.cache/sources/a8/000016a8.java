...
public class GestureDetector_OnGestureListenerImplementor implements IGCUserPeer, GestureDetector.OnGestureListener {
    ...
    private native boolean n_onFling(MotionEvent motionEvent, MotionEvent motionEvent2, float f2, float f3);

    private native void n_onLongPress(MotionEvent motionEvent);

    private native boolean n_onScroll(MotionEvent motionEvent, MotionEvent motionEvent2, float f2, float f3);
    ...
    public boolean onFling(MotionEvent motionEvent, MotionEvent motionEvent2, float f2, float f3) {
        return n_onFling(motionEvent, motionEvent2, f2, f3);
    }
    ...
    public boolean onScroll(MotionEvent motionEvent, MotionEvent motionEvent2, float f2, float f3) {
        return n_onScroll(motionEvent, motionEvent2, f2, f3);
    }
