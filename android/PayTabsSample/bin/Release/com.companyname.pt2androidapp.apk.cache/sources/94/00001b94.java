...
public class FragmentBreadCrumbs_OnBreadCrumbClickListenerImplementor implements IGCUserPeer, FragmentBreadCrumbs.OnBreadCrumbClickListener {
    ...
    private native boolean n_onBreadCrumbClick(FragmentManager.BackStackEntry backStackEntry, int i2);
    ...
    public boolean onBreadCrumbClick(FragmentManager.BackStackEntry backStackEntry, int i2) {
        return n_onBreadCrumbClick(backStackEntry, i2);
    }
