...
public final class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m1390copyRFiDyg4$default(TimedValue timedValue, Object obj, long j2, int i2, Object obj2) {
        if ((i2 & 1) != 0) {
        ...
        return timedValue.m1392copyRFiDyg4(obj, j2);
    }
    ...
    public final long m1391component2UwyO8pc() {
        return this.duration;
    }

    /* renamed from: copy-RFiDyg4  reason: not valid java name */
    public final TimedValue<T> m1392copyRFiDyg4(T t2, long j2) {
    ...
    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + Duration.m1355toStringimpl(this.duration) + ")";
    }
    ...
    public final long m1393getDurationUwyO8pc() {
        return this.duration;
    }
