...
public class LocationListenerImplementor implements IGCUserPeer, LocationListener {
    ...
    private native void n_onFlushComplete(int i2);
    ...
    private native void n_onStatusChanged(String str, int i2, Bundle bundle);
    ...
    public void onStatusChanged(String str, int i2, Bundle bundle) {
        n_onStatusChanged(str, i2, bundle);
    }

    @Override // android.location.LocationListener
    public void onFlushComplete(int i2) {
        n_onFlushComplete(i2);
    }
