...
public class FontRequestWorker {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static Typeface requestFontSync(final Context context, final FontRequest fontRequest, CallbackWithHandler callbackWithHandler, final int i2, int i3) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static Typeface requestFontAsync(final Context context, final FontRequest fontRequest, final int i2, Executor executor, final CallbackWithHandler callbackWithHandler) {
        final String createCacheId = createCacheId(fontRequest, i2);
        Typeface typeface = sTypefaceCache.get(createCacheId);
        if (typeface != null) {
            callbackWithHandler.onTypefaceResult(new TypefaceResult(typeface));
    ...
    private static String createCacheId(FontRequest fontRequest, int i2) {
        return fontRequest.getId() + "-" + i2;
    }

    static TypefaceResult getFontSync(String str, Context context, FontRequest fontRequest, int i2) {
