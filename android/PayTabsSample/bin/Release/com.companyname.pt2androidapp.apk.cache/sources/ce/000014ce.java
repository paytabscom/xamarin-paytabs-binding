...
public final class FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1 implements Flow<R> {
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        nullArrayFactory$FlowKt__ZipKt = FlowKt__ZipKt.nullArrayFactory$FlowKt__ZipKt();
        InlineMarker.mark(0);
        CombineKt.combineInternal(flowCollector, flowArr, nullArrayFactory$FlowKt__ZipKt, new FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1$lambda$1(null, this), continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
