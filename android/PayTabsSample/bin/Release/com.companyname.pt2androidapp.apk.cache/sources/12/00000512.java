...
public final class PackageInfoCompat {
    ...
    public static boolean hasSignatures(PackageManager packageManager, String str, Map<byte[], Integer> map, boolean z2) throws PackageManager.NameNotFoundException {
        if (map.isEmpty()) {
            return false;
        }
