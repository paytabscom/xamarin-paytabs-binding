...
public interface SendChannel<E> {
    ...
    Object mo1435trySendJP2dKIU(E e2);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e2) {
            Object mo1435trySendJP2dKIU = sendChannel.mo1435trySendJP2dKIU(e2);
            if (ChannelResult.m1450isSuccessimpl(mo1435trySendJP2dKIU)) {
                return true;
            }
            Throwable m1444exceptionOrNullimpl = ChannelResult.m1444exceptionOrNullimpl(mo1435trySendJP2dKIU);
