...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e2) {
        ...
        if (e2 instanceof CopyableThrowable) {
            try {
                ...
                m42constructorimpl = Result.m42constructorimpl(((CopyableThrowable) e2).createCopy());
            } catch (Throwable th) {
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i2) {
        Integer m42constructorimpl;
        JvmClassMappingKt.getKotlinClass(cls);
        try {
            Result.Companion companion = Result.Companion;
            m42constructorimpl = Result.m42constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m42constructorimpl = Result.m42constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m48isFailureimpl(m42constructorimpl)) {
            m42constructorimpl = valueOf;
        }
        return ((Number) m42constructorimpl).intValue();
    }
