...
class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    private static final String toRelativeStringOrNull$FilesKt__UtilsKt(File file, File file2) {
        ...
        if (i2 < size2) {
            ...
            CollectionsKt.joinTo(CollectionsKt.drop(normalize$FilesKt__UtilsKt.getSegments(), i2), sb, (r14 & 2) != 0 ? ", " : str, (r14 & 4) != 0 ? "" : null, (r14 & 8) != 0 ? "" : null, (r14 & 16) != 0 ? -1 : 0, (r14 & 32) != 0 ? "..." : null, (r14 & 64) != 0 ? null : null);
        }
        return sb.toString();
    }
    ...
    public static final File copyTo(File copyTo, File target, boolean z2, int i2) {
        ...
        if (copyTo.isDirectory()) {
            ...
            try {
                ...
                Throwable th2 = null;
                ByteStreamsKt.copyTo(fileInputStream2, fileOutputStream, i2);
