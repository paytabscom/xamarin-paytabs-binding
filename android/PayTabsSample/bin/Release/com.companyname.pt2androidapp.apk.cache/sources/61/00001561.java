...
public class MapsKt__MapsKt extends MapsKt__MapsJVMKt {
    ...
    private static final <K, V> Map<K, V> buildMap(int i2, Function1<? super Map<K, V>, Unit> function1) {
    ...
    private static final <K, V> boolean contains(Map<? extends K, ? extends V> contains, K k2) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.containsKey(k2);
    }

    private static final <K, V> V get(Map<? extends K, ? extends V> get, K k2) {
        Intrinsics.checkNotNullParameter(get, "$this$get");
        return get.get(k2);
    }

    private static final <K, V> void set(Map<K, V> set, K k2, V v2) {
    ...
    private static final <K, V> V getOrElse(Map<K, ? extends V> map, K k2, Function0<? extends V> function0) {
        V v2 = map.get(k2);
        return v2 != null ? v2 : function0.invoke();
    }
    ...
    public static final <K, V> V getOrElseNullable(Map<K, ? extends V> getOrElseNullable, K k2, Function0<? extends V> defaultValue) {
        ...
        V v2 = getOrElseNullable.get(k2);
        return (v2 != null || getOrElseNullable.containsKey(k2)) ? v2 : defaultValue.invoke();
    }

    public static final <K, V> V getValue(Map<K, ? extends V> getValue, K k2) {
        Intrinsics.checkNotNullParameter(getValue, "$this$getValue");
        return (V) MapsKt.getOrImplicitDefaultNullable(getValue, k2);
    }
    ...
    private static final <K, V> void minusAssign(Map<K, V> minusAssign, K k2) {
