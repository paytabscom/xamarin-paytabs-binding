...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"n_onError:(Lcom/payment/paymentsdk/integrationmodels/PaymentSdkError;)V:GetOnError_Lcom_payment_paymentsdk_integrationmodels_PaymentSdkError_Handler:Com.Payment.Paymentsdk.Sharedclasses.Interfaces.ICallbackPaymentInterfaceInvoker, Payment.Binding\n" +
			"n_onPaymentCancel:()V:GetOnPaymentCancelHandler:Com.Payment.Paymentsdk.Sharedclasses.Interfaces.ICallbackPaymentInterfaceInvoker, Payment.Binding\n" +
			"n_onPaymentFinish:(Lcom/payment/paymentsdk/integrationmodels/PaymentSdkTransactionDetails;)V:GetOnPaymentFinish_Lcom_payment_paymentsdk_integrationmodels_PaymentSdkTransactionDetails_Handler:Com.Payment.Paymentsdk.Sharedclasses.Interfaces.ICallbackPaymentInterfaceInvoker, Payment.Binding\n" +
