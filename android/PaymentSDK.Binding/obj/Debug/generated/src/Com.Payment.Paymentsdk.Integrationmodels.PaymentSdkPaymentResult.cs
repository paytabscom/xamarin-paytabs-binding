...
namespace Com.Payment.Paymentsdk.Integrationmodels {
	...
	public sealed partial class PaymentSdkPaymentResult : global::Java.Lang.Object {
		...
		public unsafe PaymentSdkPaymentResult (string responseCode, string responseMessage, string responseStatus, string transactionTime) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
