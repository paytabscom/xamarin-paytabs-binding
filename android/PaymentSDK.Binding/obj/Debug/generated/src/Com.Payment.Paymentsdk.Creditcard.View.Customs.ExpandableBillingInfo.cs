...
namespace Com.Payment.Paymentsdk.Creditcard.View.Customs {
	...
	public sealed partial class ExpandableBillingInfo : global::AndroidX.ConstraintLayout.Widget.ConstraintLayout {
		...
		public unsafe ExpandableBillingInfo (global::Android.Content.Context context) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
		...
		public unsafe ExpandableBillingInfo (global::Android.Content.Context context, global::Android.Util.IAttributeSet attrs) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
		...
		public unsafe ExpandableBillingInfo (global::Android.Content.Context context, global::Android.Util.IAttributeSet attrs, int defStyle) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
		...
		public unsafe bool IsValid {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.payment.paymentsdk.creditcard.view.customs']/class[@name='ExpandableBillingInfo']/method[@name='isValid' and count(parameter)=0]"
			[Register ("isValid", "()Z", "")]
			get {
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.payment.paymentsdk.creditcard.view.customs']/class[@name='ExpandableBillingInfo']/method[@name='setData' and count(parameter)=3 and parameter[1][@type='com.payment.paymentsdk.sharedclasses.base.BaseBillingShippingDetails'] and parameter[2][@type='androidx.lifecycle.LifecycleOwner'] and parameter[3][@type='kotlin.jvm.functions.Function0&lt;kotlin.Unit&gt;']]"
		[Register ("setData", "(Lcom/payment/paymentsdk/sharedclasses/base/BaseBillingShippingDetails;Landroidx/lifecycle/LifecycleOwner;Lkotlin/jvm/functions/Function0;)V", "")]
		public unsafe void SetData (global::Com.Payment.Paymentsdk.Sharedclasses.Base.BaseBillingShippingDetails data, global::AndroidX.Lifecycle.ILifecycleOwner lifeCycleOwner, global::Kotlin.Jvm.Functions.IFunction0 onCountryClicked)
		{
			const string __id = "setData.(Lcom/payment/paymentsdk/sharedclasses/base/BaseBillingShippingDetails;Landroidx/lifecycle/LifecycleOwner;Lkotlin/jvm/functions/Function0;)V";
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [3];
				...
				__args [2] = new JniArgumentValue ((onCountryClicked == null) ? IntPtr.Zero : ((global::Java.Lang.Object) onCountryClicked).Handle);
				_members.InstanceMethods.InvokeNonvirtualVoidMethod (__id, this, __args);
			} finally {
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.payment.paymentsdk.creditcard.view.customs']/class[@name='ExpandableBillingInfo']/method[@name='validate' and count(parameter)=0]"
		[Register ("validate", "()V", "")]
