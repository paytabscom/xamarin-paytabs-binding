...
namespace Com.Payment.Paymentsdk.Apms.Viewmodel {

	// Metadata.xml XPath class reference: path="/api/package[@name='com.payment.paymentsdk.apms.viewmodel']/class[@name='ApmViewModel']"
	[global::Android.Runtime.Register ("com/payment/paymentsdk/apms/viewmodel/ApmViewModel", DoNotGenerateAcw=true)]
	public sealed partial class ApmViewModel : global::Com.Payment.Paymentsdk.Helper.Base.BaseViewModel {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/payment/paymentsdk/apms/viewmodel/ApmViewModel", typeof (ApmViewModel));
		...
		internal ApmViewModel (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.payment.paymentsdk.apms.viewmodel']/class[@name='ApmViewModel']/constructor[@name='ApmViewModel' and count(parameter)=1 and parameter[1][@type='com.payment.paymentsdk.apms.model.repo.ApmRepo']]"
		[Register (".ctor", "(Lcom/payment/paymentsdk/apms/model/repo/ApmRepo;)V", "")]
		public unsafe ApmViewModel (global::Com.Payment.Paymentsdk.Apms.Model.Repo.ApmRepo repo) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
		...
		public unsafe global::AndroidX.Lifecycle.MutableLiveData PaymentSucceed3dsLD {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.payment.paymentsdk.apms.viewmodel']/class[@name='ApmViewModel']/method[@name='getPaymentSucceed3dsLD' and count(parameter)=0]"
		...
		public unsafe global::AndroidX.Lifecycle.MutableLiveData PaymentSucceedWithout3dsLD {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.payment.paymentsdk.apms.viewmodel']/class[@name='ApmViewModel']/method[@name='getPaymentSucceedWithout3dsLD' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.payment.paymentsdk.apms.viewmodel']/class[@name='ApmViewModel']/method[@name='buildRequestBody' and count(parameter)=1 and parameter[1][@type='com.payment.paymentsdk.integrationmodels.PaymentSdkConfigurationDetails']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.payment.paymentsdk.apms.viewmodel']/class[@name='ApmViewModel']/method[@name='doTransaction' and count(parameter)=1 and parameter[1][@type='com.payment.paymentsdk.sharedclasses.model.request.TransactionRequestBody']]"
